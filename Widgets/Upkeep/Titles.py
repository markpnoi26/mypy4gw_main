...
MODULE_ALIASES = ['Guild Wars/Titles.py']
...
asuran_map_names = {
    ...
    "Verdant Cascades",
    "Vlox's Falls",
    "Finding the Bloodstone (Level 1)",
    "Finding the Bloodstone (Level 2)",
    "Finding the Bloodstone (Level 3)",
    "The Elusive Golemancer (Level 1)",
    "The Elusive Golemancer (Level 2)",
    "The Elusive Golemancer (Level 3)",
}

deldrimor_map_names = {
    "A Gate Too Far (Level 1)",
    "A Gate Too Far (Level 2)",
    "A Gate Too Far (Level 3)",
    "A Time for Heroes",
    "Central Transfer Chamber",
    "Destruction's Depths (Level 1)",
    "Destruction's Depths (Level 2)",
    "Destruction's Depths (Level 3)",
    "Genius Operated Living Enchanted Manifestation",
    "Glint's Challenge",
    "Raven's Point (Level 1)",
    "Raven's Point (Level 2)",
...
vanguard_map_names = {
    ...
    "Warband Training",
    "Warband of Brothers (Level 1)",
    "Warband of Brothers (Level 2)",
