...
import PyImGui
from Core import *
from Core import ImGui, GLOBAL_CACHE
...
from Core import ConsoleLog, Routines, Player
...
RAW_SKILLS = [
    ...
    (
        ...
        'Spell. Summon a level 14...20 assassin that has Iron Palm, Fox Fangs, and Nine Tail Strike; it Shadow Steps to this foe. If this foe is a Charr, the assassin lives for 24...30 seconds.',
    ),
    (
        ...
        'Spell. Deals 54...90 piercing damage and inflicts Bleeding condition (5...25 seconds). 10% chance of big bonus damage; more if target is a Charr.',
    ),
    (
        'signet_of_infection',
        'Signet of Infection',
    ...
    (
        ...
        'Deldrimor',
        'Unlock_ear_bite',
        'Touch. Deals 50...70 piercing dmg and inflicts Bleeding (15...25 seconds).',
    ),
    (
        'great_dwarf_armor',
        'Great Dwarf Armor',
...
def main():
    _ensure_built()
    bot.Update()
    bot.UI.draw_window(icon_path=TEXTURE, main_child_dimensions=(280, 370), additional_ui=draw_portal_ui)
