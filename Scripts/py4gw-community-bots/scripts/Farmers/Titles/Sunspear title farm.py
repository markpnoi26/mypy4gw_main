from Core import *
from Core import Botting, Map, Player, ConsoleLog, Agent, Routines, GLOBAL_CACHE, TitleID, TITLE_TIERS
...
class BotSettings:
    ...
    TEXTURE = os.path.join(
        PySystem.Console.get_projects_path(), "Textures", "Skill_Icons", "[1816] - Sunspear Rebirth Signet.jpg"
    )
...
_hero_cfg = JsonFactory(
    f"Widgets/Bots/{BotSettings.BOT_NAME}/Heroes.json"
