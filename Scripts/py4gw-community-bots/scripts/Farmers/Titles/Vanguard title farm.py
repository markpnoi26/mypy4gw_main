...
from Core import Botting, Routines, GLOBAL_CACHE, Agent, Player, ConsoleLog, ModelID, HeroType
...
def _do_bless_and_path(
    bot: Botting, bless_xy: tuple[float, float], path: list[tuple[float, float]], label: str
) -> None:
...
REFORGED_TEXTURE = os.path.join(
    PySystem.Console.get_projects_path(), "Textures", "Skill_Icons", "[2233] - Ebon Battle Standard of Honor.jpg"
)
