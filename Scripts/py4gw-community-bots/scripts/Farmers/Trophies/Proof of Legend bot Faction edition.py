...
from Core import Map, Player, UIManager
            ...
            BehaviorTree.SwitchNode(
                ...
                cases=[
                    (
                        "Mesmer",
                        lambda: QuestDialog(
                            "Accept - Choose Your Secondary Profession",
                            V(-92, 9217),
                            0x813D08,
                            quest_id=317,
                            mode="accept",
                ...
                default_case=QuestDialog(
                    "Accept - Choose Your Secondary Profession", V(-92, 9217), 0x813D0E, quest_id=317, mode="accept"
                ).root,
            ),
            QuestDialog(
                "Complete - Choose Your Secondary Profession",
                V(-92, 9217),
                0x813D07,
                quest_id=317,
                mode="complete",
