...
from Core import Botting, ConsoleLog, Routines, Agent, Player

BOT_NAME = "Ssaresh's Kris Daggers Farm"
MODULE_ICON = "Textures\\Module_Icons\\Ssaresh's Kris Daggers.png"
bot = Botting(BOT_NAME)

KILLING_PATH = [(-21300, 7346), (-20330, 4770), (-18717, 3333), (-19402, 1440)]
...
def tooltip():
    ...
    PyImGui.bullet_text(
        "Designed for Hard Mode (HM) for faster and easy run, but can be change editing True or False in the code."
    )
