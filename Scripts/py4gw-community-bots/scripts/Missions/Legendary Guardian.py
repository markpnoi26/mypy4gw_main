...
class BotVars:
    def __init__(self, map_id=0):
        ...
        self.TheGreatNorthernWall_CoordinateList_2 = [
            (6269, -10220),
            (3830, -6054),
            (1387, -4164),
            (-906, -4404),
        ...
        self.TheGreatNorthernWall_CoordinateList_4 = [
            (-10558, 7708),
            (-8964, 9797),
            (-7750, 11127),
            (-5940, 11081),
        ...
        self.TheGreatNorthernWall_CoordinateList_5 = [
            (-3666, 10811),
            (-4721, 13321),
            (-5707, 14442),
            (-5494, 15835),
        ...
        self.TheGreatNorthernWall_CoordinateList_6 = [
            (-8974, 14371),
            (-7386, 16049),
            (-5739, 18268),
            (-3350, 17785),
        ...
        self.TheGreatNorthernWall_CoordinateList_8 = [
            (-477, 15126),
            (1404, 17353),
            (-1192, 19559),
            (-3019, 19725),
        ...
        self.TheGreatNorthernWall_CoordinateList_9 = [
            (-14464, 4187),
            (-8647, 79),
            (-7699, -2235),
            (-2332, -5860),
        ...
        # FORT RANIK
        self.FortRanik = 29
        self.FortRanik_CoordinateList_1 = [
            (-4509, -28034),
            (-3951, -24822),
            (-3493, -20759),
            (-4274, -18566),
        ...
        self.FortRanik_CoordinateList_2 = [
            (-268, -9207),
            (1494, -7661),
            (2317, -6770),
            (3687, -7241),
        ...
        self.FortRanik_CoordinateList_3 = [
            (6736, -1393),
            (6664, 1229),
            (5244, 3467),
            (2586, 5261),
        ...
        self.FortRanik_CoordinateList_9 = [
            (124, 16756),
            (1034, 20924),
            (-3575, 16829),
            (-4531, 16479),
        ...
        self.FortRanik_CoordinateList_10 = [
            (-2022, 18352),
            (-4317, 17500),
            (-6316, 18870),
            (-5866, 19400),
        ...
        self.RuinsOfSurmia_CoordinateList_1 = [
            (-3134, -11907),
            (-757, -9155),
            (-2201, -7296),
            (-3836, -6823),
        ...
        self.RuinsOfSurmia_CoordinateList_2 = [
            (-1923, 16707),
            (-3878, 18778),
            (-1989, 20932),
            (3077, 20568),
        ...
        self.RuinsOfSurmia_CoordinateList_4 = [
            (8028, 18967),
            (5503, 17839),
            (1339, 18994),
            (-1007, 20385),
        ...
        self.RuinsOfSurmia_CoordinateList_7 = [
            (-8762, 18662),
            (-8750, 16236),
            (-8639, 14939),
            (-9964, 15661),
        ...
        self.RuinsOfSurmia_CoordinateList_8 = [
            (9547, 23274),
            (9808, 26873),
            (10303, 28840),
            (9139, 31260),
        ...
        self.NolaniAcademy_CoordinateList_1 = [
            (-1574, 13049),
            (-2068, 11923),
            (632, 12809),
            (926, 11537),
        ...
        self.NolaniAcademy_CoordinateList_2 = [
            (9785, 4132),
            (7403, 5689),
            (5922, 5479),
            (6803, 2028),
        ...
        self.NolaniAcademy_CoordinateList_3 = [
            (-12489, -6389),
            (-10366, -5642),
            (-8082, -3865),
            (-6798, -1585),
        ...
        self.NolaniAcademy_CoordinateList_4 = [
            (4957, -2770),
            (7089, -4433),
            (9589, -5261),
            (11418, -5969),
        ...
        self.NolaniAcademy_CoordinateList_5 = [
            (8941, -7633),
            (7915, -8596),
            (7756, -9062),
            (6937, -10029),
        ...
        self.BorlisPass_CoordinateList_12 = [
            (2143, 2869),
            (508, 2609),
            (-1339, 3485),
            (-945, 963),
        ...
        self.BorlisPass_CoordinateList_19 = [
            (2153, -9157),
            (3803, -9267),
            (5687, -8775),
            (9528, -9258),
        ...
        self.BorlisPass_CoordinateList_21 = [
            (-878, -5419),
            (-2756, -5098),
            (-6123, -4629),
            (-9086, -5156),
        ...
        self.BorlisPass_CoordinateList_22 = [
            (-14170, 6066),
            (-18092, 4544),
            (-17622, 1374),
            (-15412, -2347),
        ...
        self.TheFrostGate_CoordinateList_1 = [
            (1720, 28972),
            (168, 28288),
            (-1465, 27585),
            (-1951, 28577),
        ...
        self.TheFrostGate_CoordinateList_2 = [
            (7209, -3653),
            (7653, -932),
            (4971, 761),
            (1751, -413),
        ...
        self.TheFrostGate_CoordinateList_3 = [
            (-5957, -7875),
            (-4199, -4686),
            (-3194, -2666),
            (-2378, -3149),
        ...
        self.TheFrostGate_CoordinateList_4 = [
            (5058, -6409),
            (423, -6364),
            (-2423, -3094),
            (-3549, -2917),
        ...
        self.TheFrostGate_CoordinateList_5 = [
            (-5959, -7940),
            (-3211, -2798),
            (-2144, -3333),
            (216, -6443),
        ...
        self.TheFrostGate_CoordinateList_7 = [
            (5391, -15153),
            (5255, -15812),
            (2952, -16918),
            (686, -19303),
        ...
        self.GatesOfKryta_CoordinateList_2 = [
            (2900, 18428),
            (1781, 16370),
            (885, 15728),
            (-784, 17210),
        ...
        self.GatesOfKryta_CoordinateList_4 = [
            (-7794, -1604),
            (-8508, -4074),
            (-7545, -7102),
            (-6824, -8185),
        ...
        self.GatesOfKryta_CoordinateList_5 = [
            (-3756, 8355),
            (-3154, 6633),
            (1224, 4814),
            (1711, 2861),
        ...
        self.GatesOfKryta_CoordinateList_6 = [
            (-8483, -3477),
            (-7441, -7498),
            (-2986, -10872),
            (258, -12823),
        ...
        self.GatesOfKryta_CoordinateList_7 = [
            (10787, -11322),
            (11704, -9324),
            (12872, -8430),
            (12878, -4664),
        ...
        self.DAlessioSeabord_CoordinateList_1 = [
            (20076, 6497),
            (21070, 4409),
            (20377, 2544),
            (17922, 1885),
        ...
        self.DAlessioSeabord_CoordinateList_3 = [
            (10287, 6829),
            (9242, 8149),
            (11227, 8273),
            (8764, 11561),
        ...
        self.DAlessioSeabord_CoordinateList_5 = [
            (-9671, 11209),
            (-9740, 8390),
            (-8995, 5916),
            (-5817, 4232),
        ...
        self.DAlessioSeabord_CoordinateList_6 = [
            (-12358, 4289),
            (-13863, 3011),
            (-14967, 1859),
            (-16700, 4012),
        ...
        self.DAlessioSeabord_CoordinateList_7 = [
            (-16806, 13253),
            (-17844, 13968),
            (-19695, 13918),
            (-20150, 12918),
        ...
        self.DivinityCoast_CoordinateList_1 = [
            (16689, -6138),
            (16723, -3945),
            (20771, -3354),
            (21665, 2231),
        ...
        self.DivinityCoast_CoordinateList_2 = [
            (16965, 12672),
            (17207, 11014),
            (18264, 10118),
            (19123, 9635),
        ...
        self.DivinityCoast_CoordinateList_3 = [
            (16421, 13052),
            (14392, 12452),
            (12732, 12158),
            (8627, 12203),
        ...
        # THE WILDS
        self.TheWilds = 11
        self.TheWilds_CoordinateList_1 = [
            (15697, -9078),
            (15993, -6660),
            (16228, -4981),
            (14238, -5132),
        ...
        self.TheWilds_CoordinateList_3 = [
            (20, -12495),
            (3096, -12485),
            (7033, -12735),
            (9614, -12965),
        ...
        self.TheWilds_CoordinateList_4 = [
            (2321, 2003),
            (4200, 2852),
            (5667, 3875),
            (7624, 6976),
        ...
        self.TheWilds_CoordinateList_5 = [
            (13834, 12693),
            (14179, 10825),
            (13669, 9083),
            (13709, 7733),
...
bot_vars.window_module = ImGui.WindowModule(
    module_name,
    window_name="TH3KUM1KO'S LEGENDARY GUARDIAN BOT",
    window_size=(800, 800),
...
class StateMachineVars:
    def __init__(self):
        ...
        self.TheGreatNorthernWall_Pathing_1 = Routines.Movement.PathHandler(
            bot_vars.TheGreatNorthernWall_CoordinateList_1
        )
        self.TheGreatNorthernWall_Pathing_2 = Routines.Movement.PathHandler(
            bot_vars.TheGreatNorthernWall_CoordinateList_2
        )
        self.TheGreatNorthernWall_Pathing_3 = Routines.Movement.PathHandler(
            bot_vars.TheGreatNorthernWall_CoordinateList_3
        )
        self.TheGreatNorthernWall_Pathing_4 = Routines.Movement.PathHandler(
            bot_vars.TheGreatNorthernWall_CoordinateList_4
        )
        self.TheGreatNorthernWall_Pathing_5 = Routines.Movement.PathHandler(
            bot_vars.TheGreatNorthernWall_CoordinateList_5
        )
        self.TheGreatNorthernWall_Pathing_6 = Routines.Movement.PathHandler(
            bot_vars.TheGreatNorthernWall_CoordinateList_6
        )
        self.TheGreatNorthernWall_Pathing_7 = Routines.Movement.PathHandler(
            bot_vars.TheGreatNorthernWall_CoordinateList_7
        )
        self.TheGreatNorthernWall_Pathing_8 = Routines.Movement.PathHandler(
            bot_vars.TheGreatNorthernWall_CoordinateList_8
        )
        self.TheGreatNorthernWall_Pathing_9 = Routines.Movement.PathHandler(
            bot_vars.TheGreatNorthernWall_CoordinateList_9
        )
...
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="TRAVEL TO OUTPOST",
    execute_fn=lambda: Map.Travel(bot_vars.TheGreatNorthernWall),
    exit_condition=lambda: Map.IsMapReady() and Map.IsOutpost() and Party.IsPartyLoaded(),
...
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="SET GAME MODE",
    execute_fn=lambda: SetGameMode(),
    exit_condition=lambda: Map.IsOutpost(),
    transition_delay_ms=2000,
    run_once=True,
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="ADD HEROES 4", execute_fn=lambda: AddSelectedHeroes4(), transition_delay_ms=2000, run_once=True
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="SET VANGUARD TITLE",
    execute_fn=lambda: Player.SetActiveTitle(bot_vars.Vanguard_Title),
    transition_delay_ms=2000,
    run_once=True,
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="ENTER BATTLE", execute_fn=lambda: Map.EnterChallenge(), transition_delay_ms=2000, run_once=True
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="PRESS ENTER",
    execute_fn=lambda: Keystroke.PressAndRelease(Key.Enter.value),
...
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="MAP PATH 1",
    execute_fn=lambda: handle_map_path(FSM_vars.TheGreatNorthernWall_Pathing_1),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheGreatNorthernWall_Pathing_1, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
...
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="MAP PATH 2",
    execute_fn=lambda: handle_map_path(FSM_vars.TheGreatNorthernWall_Pathing_2),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheGreatNorthernWall_Pathing_2, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="CHECK GADGET", execute_fn=lambda: handle_gadget_interaction(), transition_delay_ms=1000, run_once=True
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="MAP PATH 3",
    execute_fn=lambda: handle_map_path(FSM_vars.TheGreatNorthernWall_Pathing_3),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheGreatNorthernWall_Pathing_3, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
...
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="MAP PATH 4",
    execute_fn=lambda: handle_map_path(FSM_vars.TheGreatNorthernWall_Pathing_4),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheGreatNorthernWall_Pathing_4, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
...
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="MAP PATH 5",
    execute_fn=lambda: handle_map_path(FSM_vars.TheGreatNorthernWall_Pathing_5),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheGreatNorthernWall_Pathing_5, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
...
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="MAP PATH 6",
    execute_fn=lambda: handle_map_path(FSM_vars.TheGreatNorthernWall_Pathing_6),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheGreatNorthernWall_Pathing_6, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
...
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="MAP PATH 7",
    execute_fn=lambda: handle_map_path(FSM_vars.TheGreatNorthernWall_Pathing_7),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheGreatNorthernWall_Pathing_7, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=1000, run_once=True
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="PRESS SPACE",
...
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="MAP PATH 8",
    execute_fn=lambda: handle_map_path(FSM_vars.TheGreatNorthernWall_Pathing_8),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheGreatNorthernWall_Pathing_8, FSM_vars.movement_handler
    )
    or (Map.IsMapReady() and Map.IsExplorable() and Party.IsPartyLoaded() and Map.IsInCinematic()),
    run_once=False,
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="WAITING CINEMATIC",
    exit_condition=lambda: Map.IsMapReady() and Map.IsExplorable() and Party.IsPartyLoaded() and Map.IsInCinematic(),
    transition_delay_ms=500,
    run_once=True,
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="SKIP CINEMATIC", execute_fn=lambda: Map.SkipCinematic(), transition_delay_ms=1000, run_once=True
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="MAP PATH 9",
    execute_fn=lambda: Routines.Movement.FollowPath(FSM_vars.TheGreatNorthernWall_Pathing_9, FSM_vars.movement_handler),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
...
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=5000, run_once=True
)
FSM_vars.state_machine_TheGreatNorthernWall.AddState(
    name="WAITING CINEMATIC",
    exit_condition=lambda: Map.IsMapReady() and Map.IsExplorable() and Party.IsPartyLoaded() and Map.IsInCinematic(),
...
FSM_vars.state_machine_FortRanik.AddState(
    name="TRAVEL TO OUTPOST",
    execute_fn=lambda: Map.Travel(bot_vars.FortRanik),
    exit_condition=lambda: Map.IsMapReady() and Map.IsOutpost() and Party.IsPartyLoaded(),
    transition_delay_ms=1500,
    run_once=True,
)
...
FSM_vars.state_machine_FortRanik.AddState(
    name="MAP PATH 1",
    execute_fn=lambda: handle_map_path(FSM_vars.FortRanik_Pathing_1),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.FortRanik_Pathing_1, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_FortRanik.AddState(
...
FSM_vars.state_machine_FortRanik.AddState(
    name="MAP PATH 2",
    execute_fn=lambda: handle_map_path(FSM_vars.FortRanik_Pathing_2),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.FortRanik_Pathing_2, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_FortRanik.AddState(
...
FSM_vars.state_machine_FortRanik.AddState(
    name="MAP PATH 3",
    execute_fn=lambda: handle_map_path(FSM_vars.FortRanik_Pathing_3),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.FortRanik_Pathing_3, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_FortRanik.AddState(
    name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=3000, run_once=True
)
FSM_vars.state_machine_FortRanik.AddState(
    name="PRESS ESC",
...
FSM_vars.state_machine_FortRanik.AddState(
    name="MAP PATH 4",
    execute_fn=lambda: handle_map_path(FSM_vars.FortRanik_Pathing_4),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.FortRanik_Pathing_4, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_FortRanik.AddState(
    name="CHECK GADGET", execute_fn=lambda: handle_gadget_interaction(), transition_delay_ms=2000, run_once=True
)
FSM_vars.state_machine_FortRanik.AddState(
    name="CHECK ITEM", execute_fn=lambda: handle_item_interaction(), transition_delay_ms=2000, run_once=True
)
FSM_vars.state_machine_FortRanik.AddState(
    name="MAP PATH 5",
    execute_fn=lambda: handle_map_path(FSM_vars.FortRanik_Pathing_5),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.FortRanik_Pathing_5, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_FortRanik.AddState(
    name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=5000, run_once=True
)
FSM_vars.state_machine_FortRanik.AddState(
    name="MAP PATH 6",
    execute_fn=lambda: handle_map_path(FSM_vars.FortRanik_Pathing_6),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.FortRanik_Pathing_6, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_FortRanik.AddState(
...
FSM_vars.state_machine_FortRanik.AddState(
    name="MAP PATH 5a",
    execute_fn=lambda: handle_map_path(FSM_vars.FortRanik_Pathing_5a),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.FortRanik_Pathing_5a, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_FortRanik.AddState(
...
FSM_vars.state_machine_FortRanik.AddState(
    name="MAP PATH 7",
    execute_fn=lambda: handle_map_path(FSM_vars.FortRanik_Pathing_7),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.FortRanik_Pathing_7, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_FortRanik.AddState(
...
FSM_vars.state_machine_FortRanik.AddState(
    name="MAP PATH 8",
    execute_fn=lambda: handle_map_path(FSM_vars.FortRanik_Pathing_8),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.FortRanik_Pathing_8, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_FortRanik.AddState(
...
FSM_vars.state_machine_FortRanik.AddState(
    name="CHECK GADGET", execute_fn=lambda: handle_gadget_interaction(), transition_delay_ms=7000, run_once=True
)
FSM_vars.state_machine_FortRanik.AddState(
    name="PRESS SPACE",
    execute_fn=lambda: Keystroke.PressAndRelease(Key.Space.value),
...
FSM_vars.state_machine_FortRanik.AddState(
    name="MAP PATH 9",
    execute_fn=lambda: handle_map_path(FSM_vars.FortRanik_Pathing_9),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.FortRanik_Pathing_9, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_FortRanik.AddState(
...
FSM_vars.state_machine_FortRanik.AddState(
    name="MAP PATH 10",
    execute_fn=lambda: handle_map_path(FSM_vars.FortRanik_Pathing_10),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.FortRanik_Pathing_10, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_FortRanik.AddState(
    name="PRESS ESC END MAP",
    execute_fn=lambda: Keystroke.PressAndRelease(Key.Escape.value),
    exit_condition=lambda: Map.IsOutpost(),
    run_once=True,
)
...
FSM_vars.state_machine_RuinsOfSurmia.AddState(
    name="TRAVEL TO OUTPOST",
    execute_fn=lambda: Map.Travel(bot_vars.RuinsOfSurmia),
    exit_condition=lambda: Map.IsMapReady() and Map.IsOutpost() and Party.IsPartyLoaded(),
    transition_delay_ms=1500,
    run_once=True,
)
...
FSM_vars.state_machine_RuinsOfSurmia.AddState(
    name="MAP PATH 1",
    execute_fn=lambda: handle_map_path(FSM_vars.RuinsOfSurmia_Pathing_1),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.RuinsOfSurmia_Pathing_1, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_RuinsOfSurmia.AddState(
...
FSM_vars.state_machine_RuinsOfSurmia.AddState(
    name="MAP PATH 2",
    execute_fn=lambda: handle_map_path(FSM_vars.RuinsOfSurmia_Pathing_2),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.RuinsOfSurmia_Pathing_2, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_RuinsOfSurmia.AddState(
    name="MAP PATH 3 - PEACE",
    execute_fn=lambda: handle_map_path_peace(FSM_vars.RuinsOfSurmia_Pathing_3),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.RuinsOfSurmia_Pathing_3, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_RuinsOfSurmia.AddState(
...
FSM_vars.state_machine_RuinsOfSurmia.AddState(
    name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=45000, run_once=True
)
FSM_vars.state_machine_RuinsOfSurmia.AddState(
    name="MAP PATH 4 - FOLLOW WITH DELAY TIMER",
    execute_fn=lambda: FollowPathwithDelayTimer(FSM_vars.RuinsOfSurmia_Pathing_4, FSM_vars.movement_handler),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.RuinsOfSurmia_Pathing_4, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_RuinsOfSurmia.AddState(
    name="MAP PATH 5",
    execute_fn=lambda: handle_map_path(FSM_vars.RuinsOfSurmia_Pathing_5),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.RuinsOfSurmia_Pathing_5, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_RuinsOfSurmia.AddState(
    name="MAP PATH 6 - FOLLOW WITH DELAY TIMER",
    execute_fn=lambda: FollowPathwithDelayTimer(FSM_vars.RuinsOfSurmia_Pathing_6, FSM_vars.movement_handler),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.RuinsOfSurmia_Pathing_6, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_RuinsOfSurmia.AddState(
    name="MAP PATH 7",
    execute_fn=lambda: handle_map_path(FSM_vars.RuinsOfSurmia_Pathing_7),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.RuinsOfSurmia_Pathing_7, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_RuinsOfSurmia.AddState(
    name="CHECK GADGET", execute_fn=lambda: handle_gadget_interaction(), transition_delay_ms=10000, run_once=True
)
FSM_vars.state_machine_RuinsOfSurmia.AddState(
    name="MAP PATH 8",
    execute_fn=lambda: handle_map_path(FSM_vars.RuinsOfSurmia_Pathing_8),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.RuinsOfSurmia_Pathing_8, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_RuinsOfSurmia.AddState(
...
FSM_vars.state_machine_NolaniAcademy.AddState(
    name="TRAVEL TO OUTPOST",
    execute_fn=lambda: Map.Travel(bot_vars.NolaniAcademy),
    exit_condition=lambda: Map.IsMapReady() and Map.IsOutpost() and Party.IsPartyLoaded(),
    transition_delay_ms=1500,
    run_once=True,
)
...
FSM_vars.state_machine_NolaniAcademy.AddState(
    name="MAP PATH 1",
    execute_fn=lambda: handle_map_path(FSM_vars.NolaniAcademy_Pathing_1),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.NolaniAcademy_Pathing_1, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_NolaniAcademy.AddState(
    name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=10000, run_once=True
)
FSM_vars.state_machine_NolaniAcademy.AddState(
    name="CHECK ITEM", execute_fn=lambda: handle_item_interaction(), transition_delay_ms=2000, run_once=True
)
FSM_vars.state_machine_NolaniAcademy.AddState(
    name="MAP PATH 2",
    execute_fn=lambda: handle_map_path(FSM_vars.NolaniAcademy_Pathing_2),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.NolaniAcademy_Pathing_2, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_NolaniAcademy.AddState(
...
FSM_vars.state_machine_NolaniAcademy.AddState(
    name="MAP PATH 3",
    execute_fn=lambda: handle_map_path(FSM_vars.NolaniAcademy_Pathing_3),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.NolaniAcademy_Pathing_3, FSM_vars.movement_handler
    )
    or (Map.IsMapReady() and Map.IsExplorable() and Party.IsPartyLoaded() and Map.IsInCinematic()),
    run_once=False,
)
FSM_vars.state_machine_NolaniAcademy.AddState(
    name="WAITING CINEMATIC MAP",
    exit_condition=lambda: Map.IsMapReady() and Map.IsExplorable() and Party.IsPartyLoaded() and Map.IsInCinematic(),
    transition_delay_ms=1500,
    run_once=True,
)
...
FSM_vars.state_machine_NolaniAcademy.AddState(
    name="MAP PATH 4",
    execute_fn=lambda: handle_map_path(FSM_vars.NolaniAcademy_Pathing_4),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.NolaniAcademy_Pathing_4, FSM_vars.movement_handler
    )
    or Map.IsOutpost(),
    run_once=False,
)
...
FSM_vars.state_machine_NolaniAcademy.AddState(
    name="MAP PATH 5",
    execute_fn=lambda: handle_map_path(FSM_vars.NolaniAcademy_Pathing_5),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.NolaniAcademy_Pathing_5, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_NolaniAcademy.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="TRAVEL TO OUTPOST",
    execute_fn=lambda: Map.Travel(bot_vars.BorlisPass),
    exit_condition=lambda: Map.IsMapReady() and Map.IsOutpost() and Party.IsPartyLoaded(),
    transition_delay_ms=1500,
    run_once=True,
)
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="ADD HEROES 6", execute_fn=lambda: AddSelectedHeroes6(), transition_delay_ms=2000, run_once=True
)
FSM_vars.state_machine_BorlisPass.AddState(
    name="ENTER BATTLE", execute_fn=lambda: Map.EnterChallenge(), transition_delay_ms=2000, run_once=True
)
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 1",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_1),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_1, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
    name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=2000, run_once=True
)
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 2",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_2),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_2, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 3",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_3),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_3, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 4",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_4),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_4, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 5",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_5),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_5, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 6",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_6),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_6, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 7",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_7),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_7, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 8",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_8),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_8, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 9",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_9),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_9, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 10",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_10),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_10, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 11",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_11),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_11, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
    name="CHANGE WEAPONSET 2",
    execute_fn=lambda: Keystroke.PressAndRelease(Key.F2.value),
    transition_delay_ms=1000,
    run_once=True,
)
FSM_vars.state_machine_BorlisPass.AddState(
    name="CHANGE WEAPONSET 1",
    execute_fn=lambda: Keystroke.PressAndRelease(Key.F1.value),
    transition_delay_ms=1000,
    run_once=True,
)
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 12",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_12),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_12, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 13",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_13),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_13, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 14",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_14),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_14, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 15",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_15),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_15, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 16",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_16),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_16, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 17",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_17),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_17, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 18",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_18),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_18, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 19",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_19),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_19, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 20",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_20),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_20, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 21",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_21),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_21, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 22",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_22),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_22, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 23",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_23),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_23, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_BorlisPass.AddState(
    name="MAP PATH 24",
    execute_fn=lambda: handle_map_path(FSM_vars.BorlisPass_Pathing_24),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.BorlisPass_Pathing_24, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_BorlisPass.AddState(
...
FSM_vars.state_machine_TheFrostGate.AddState(
    name="TRAVEL TO OUTPOST",
    execute_fn=lambda: Map.Travel(bot_vars.TheFrostGate),
    exit_condition=lambda: Map.IsMapReady() and Map.IsOutpost() and Party.IsPartyLoaded(),
    transition_delay_ms=1500,
    run_once=True,
)
...
FSM_vars.state_machine_TheFrostGate.AddState(
    name="MAP PATH 1",
    execute_fn=lambda: handle_map_path(FSM_vars.TheFrostGate_Pathing_1),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheFrostGate_Pathing_1, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheFrostGate.AddState(
...
FSM_vars.state_machine_TheFrostGate.AddState(
    name="MAP PATH 2",
    execute_fn=lambda: handle_map_path(FSM_vars.TheFrostGate_Pathing_2),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheFrostGate_Pathing_2, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheFrostGate.AddState(
    name="CHECK GADGET", execute_fn=lambda: handle_gadget_interaction(), transition_delay_ms=6000, run_once=True
)
FSM_vars.state_machine_TheFrostGate.AddState(
    name="PRESS SPACE",
    execute_fn=lambda: Keystroke.PressAndRelease(Key.Space.value),
...
FSM_vars.state_machine_TheFrostGate.AddState(
    name="MAP PATH 3",
    execute_fn=lambda: handle_map_path(FSM_vars.TheFrostGate_Pathing_3),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheFrostGate_Pathing_3, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheFrostGate.AddState(
    name="CHECK GADGET", execute_fn=lambda: handle_gadget_interaction(), transition_delay_ms=4000, run_once=True
)
FSM_vars.state_machine_TheFrostGate.AddState(
    name="CHECK ITEM", execute_fn=lambda: handle_item_interaction(), transition_delay_ms=4000, run_once=True
)
FSM_vars.state_machine_TheFrostGate.AddState(
    name="MAP PATH 4",
    execute_fn=lambda: handle_map_path(FSM_vars.TheFrostGate_Pathing_4),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheFrostGate_Pathing_4, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheFrostGate.AddState(
...
FSM_vars.state_machine_TheFrostGate.AddState(
    name="MAP PATH 5",
    execute_fn=lambda: handle_map_path(FSM_vars.TheFrostGate_Pathing_5),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheFrostGate_Pathing_5, FSM_vars.movement_handler
    )
    or (Map.IsMapReady() and Map.IsExplorable() and Party.IsPartyLoaded() and Map.IsInCinematic()),
    run_once=False,
)
...
FSM_vars.state_machine_TheFrostGate.AddState(
    name="MAP PATH 6",
    execute_fn=lambda: handle_map_path(FSM_vars.TheFrostGate_Pathing_6),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheFrostGate_Pathing_6, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheFrostGate.AddState(
...
FSM_vars.state_machine_TheFrostGate.AddState(
    name="CHECK GADGET", execute_fn=lambda: handle_gadget_interaction(), transition_delay_ms=15000, run_once=True
)
FSM_vars.state_machine_TheFrostGate.AddState(
    name="CHECK ITEM", execute_fn=lambda: handle_item_interaction(), transition_delay_ms=4000, run_once=True
)
...
FSM_vars.state_machine_TheFrostGate.AddState(
    name="MAP PATH 7",
    execute_fn=lambda: handle_map_path(FSM_vars.TheFrostGate_Pathing_7),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheFrostGate_Pathing_7, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheFrostGate.AddState(
...
FSM_vars.state_machine_TheFrostGate.AddState(
    name="MAP PATH 8",
    execute_fn=lambda: handle_map_path(FSM_vars.TheFrostGate_Pathing_8),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheFrostGate_Pathing_8, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheFrostGate.AddState(
...
FSM_vars.state_machine_TheFrostGate.AddState(
    name="MAP PATH 9",
    execute_fn=lambda: handle_map_path(FSM_vars.TheFrostGate_Pathing_9),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheFrostGate_Pathing_9, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheFrostGate.AddState(
...
FSM_vars.state_machine_GatesOfKryta.AddState(
    name="TRAVEL TO OUTPOST",
    execute_fn=lambda: Map.Travel(bot_vars.GatesOfKryta),
    exit_condition=lambda: Map.IsMapReady() and Map.IsOutpost() and Party.IsPartyLoaded(),
    transition_delay_ms=1500,
    run_once=True,
)
...
FSM_vars.state_machine_GatesOfKryta.AddState(
    name="MAP PATH 1",
    execute_fn=lambda: handle_map_path(FSM_vars.GatesOfKryta_Pathing_1),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.GatesOfKryta_Pathing_1, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_GatesOfKryta.AddState(
...
FSM_vars.state_machine_GatesOfKryta.AddState(
    name="MAP PATH 2",
    execute_fn=lambda: handle_map_path(FSM_vars.GatesOfKryta_Pathing_2),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.GatesOfKryta_Pathing_2, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_GatesOfKryta.AddState(
    name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=7500, run_once=True
)
FSM_vars.state_machine_GatesOfKryta.AddState(
    name="MAP PATH 3",
    execute_fn=lambda: handle_map_path(FSM_vars.GatesOfKryta_Pathing_3),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.GatesOfKryta_Pathing_3, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_GatesOfKryta.AddState(
...
FSM_vars.state_machine_GatesOfKryta.AddState(
    name="MAP PATH 4",
    execute_fn=lambda: handle_map_path(FSM_vars.GatesOfKryta_Pathing_4),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.GatesOfKryta_Pathing_4, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_GatesOfKryta.AddState(
...
FSM_vars.state_machine_GatesOfKryta.AddState(
    name="MAP PATH 5",
    execute_fn=lambda: handle_map_path(FSM_vars.GatesOfKryta_Pathing_5),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.GatesOfKryta_Pathing_5, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_GatesOfKryta.AddState(
...
FSM_vars.state_machine_GatesOfKryta.AddState(
    name="MAP PATH 6",
    execute_fn=lambda: handle_map_path(FSM_vars.GatesOfKryta_Pathing_6),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.GatesOfKryta_Pathing_6, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_GatesOfKryta.AddState(
...
FSM_vars.state_machine_GatesOfKryta.AddState(
    name="MAP PATH 7",
    execute_fn=lambda: handle_map_path(FSM_vars.GatesOfKryta_Pathing_7),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.GatesOfKryta_Pathing_7, FSM_vars.movement_handler
    )
    or (Map.IsMapReady() and Map.IsExplorable() and Party.IsPartyLoaded() and Map.IsInCinematic()),
    run_once=False,
)
...
FSM_vars.state_machine_DAlessioSeaboard.AddState(
    name="TRAVEL TO OUTPOST",
    execute_fn=lambda: Map.Travel(bot_vars.DAlessioSeabord),
    exit_condition=lambda: Map.IsMapReady() and Map.IsOutpost() and Party.IsPartyLoaded(),
    transition_delay_ms=1500,
    run_once=True,
)
...
FSM_vars.state_machine_DAlessioSeaboard.AddState(
    name="MAP PATH 1",
    execute_fn=lambda: handle_map_path(FSM_vars.DAlessioSeaboard_Pathing_1),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.DAlessioSeaboard_Pathing_1, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_DAlessioSeaboard.AddState(
...
FSM_vars.state_machine_DAlessioSeaboard.AddState(
    name="MAP PATH 2",
    execute_fn=lambda: handle_map_path(FSM_vars.DAlessioSeaboard_Pathing_2),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.DAlessioSeaboard_Pathing_2, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_DAlessioSeaboard.AddState(
...
FSM_vars.state_machine_DAlessioSeaboard.AddState(
    name="MAP PATH 3",
    execute_fn=lambda: handle_map_path(FSM_vars.DAlessioSeaboard_Pathing_3),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.DAlessioSeaboard_Pathing_3, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_DAlessioSeaboard.AddState(
...
FSM_vars.state_machine_DAlessioSeaboard.AddState(
    name="MAP PATH 4",
    execute_fn=lambda: handle_map_path(FSM_vars.DAlessioSeaboard_Pathing_4),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.DAlessioSeaboard_Pathing_4, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_DAlessioSeaboard.AddState(
...
FSM_vars.state_machine_DAlessioSeaboard.AddState(
    name="MAP PATH 5",
    execute_fn=lambda: handle_map_path(FSM_vars.DAlessioSeaboard_Pathing_5),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.DAlessioSeaboard_Pathing_5, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_DAlessioSeaboard.AddState(
    name="CHECK NPC", execute_fn=lambda: handle_npc_interaction(), transition_delay_ms=600000, run_once=True
)
FSM_vars.state_machine_DAlessioSeaboard.AddState(
    name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=2000, run_once=True
)
FSM_vars.state_machine_DAlessioSeaboard.AddState(
    name="MAP PATH 6",
    execute_fn=lambda: handle_map_path(FSM_vars.DAlessioSeaboard_Pathing_6),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.DAlessioSeaboard_Pathing_6, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_DAlessioSeaboard.AddState(
...
FSM_vars.state_machine_DAlessioSeaboard.AddState(
    name="MAP PATH 6",
    execute_fn=lambda: handle_map_path(FSM_vars.DAlessioSeaboard_Pathing_7),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.DAlessioSeaboard_Pathing_7, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_DAlessioSeaboard.AddState(
...
FSM_vars.state_machine_DivinityCoast.AddState(
    name="TRAVEL TO OUTPOST",
    execute_fn=lambda: Map.Travel(bot_vars.DivinityCoast),
    exit_condition=lambda: Map.IsMapReady() and Map.IsOutpost() and Party.IsPartyLoaded(),
    transition_delay_ms=1500,
    run_once=True,
)
...
FSM_vars.state_machine_DivinityCoast.AddState(
    name="MAP PATH 1",
    execute_fn=lambda: handle_map_path(FSM_vars.DivinityCoast_Pathing_1),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.DivinityCoast_Pathing_1, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_DivinityCoast.AddState(
...
FSM_vars.state_machine_DivinityCoast.AddState(
    name="MAP PATH 2",
    execute_fn=lambda: handle_map_path(FSM_vars.DivinityCoast_Pathing_2),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.DivinityCoast_Pathing_2, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_DivinityCoast.AddState(
...
FSM_vars.state_machine_DivinityCoast.AddState(
    name="MAP PATH 3",
    execute_fn=lambda: handle_map_path(FSM_vars.DivinityCoast_Pathing_3),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.DivinityCoast_Pathing_3, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_DivinityCoast.AddState(
    name="FLAG HEROES",
    execute_fn=lambda: Party.Heroes.FlagAllHeroes(-1790, 177),
    transition_delay_ms=25000,
    run_once=True,
)
FSM_vars.state_machine_DivinityCoast.AddState(
    name="MAP PATH 4",
    execute_fn=lambda: handle_map_path(FSM_vars.DivinityCoast_Pathing_4),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.DivinityCoast_Pathing_4, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_DivinityCoast.AddState(
    name="FLAG HEROES", execute_fn=lambda: Party.Heroes.UnflagAllHeroes(), transition_delay_ms=2000, run_once=True
)
FSM_vars.state_machine_DivinityCoast.AddState(
    name="CHECK QUEST", execute_fn=lambda: handle_quest_interaction(), transition_delay_ms=2000, run_once=True
)
FSM_vars.state_machine_DivinityCoast.AddState(
    name="MAP PATH 5",
    execute_fn=lambda: handle_map_path(FSM_vars.DivinityCoast_Pathing_5),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.DivinityCoast_Pathing_5, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_DivinityCoast.AddState(
...
FSM_vars.state_machine_TheWilds.AddState(
    name="TRAVEL TO OUTPOST",
    execute_fn=lambda: Map.Travel(bot_vars.TheWilds),
    exit_condition=lambda: Map.IsMapReady() and Map.IsOutpost() and Party.IsPartyLoaded(),
    transition_delay_ms=1500,
    run_once=True,
)
...
FSM_vars.state_machine_TheWilds.AddState(
    name="MAP PATH 1",
    execute_fn=lambda: handle_map_path(FSM_vars.TheWilds_Pathing_1),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheWilds_Pathing_1, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheWilds.AddState(
    ...
    execute_fn=lambda: Keystroke.PressAndRelease(Key.Enter.value),
    exit_condition=lambda: (Map.IsMapReady() and Map.IsExplorable() and Party.IsPartyLoaded()),
    transition_delay_ms=90000,
    run_once=True,
)
FSM_vars.state_machine_TheWilds.AddState(
    name="MAP PATH 2",
    execute_fn=lambda: handle_map_path(FSM_vars.TheWilds_Pathing_2),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheWilds_Pathing_2, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheWilds.AddState(
...
FSM_vars.state_machine_TheWilds.AddState(
    name="MAP PATH 3",
    execute_fn=lambda: handle_map_path(FSM_vars.TheWilds_Pathing_3),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheWilds_Pathing_3, FSM_vars.movement_handler
    )
    or (Map.IsMapReady() and Map.IsExplorable() and Party.IsPartyLoaded() and Map.IsInCinematic()),
    run_once=False,
)
...
FSM_vars.state_machine_TheWilds.AddState(
    name="MAP PATH 4",
    execute_fn=lambda: handle_map_path(FSM_vars.TheWilds_Pathing_4),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheWilds_Pathing_4, FSM_vars.movement_handler
    ),
    run_once=False,
)
FSM_vars.state_machine_TheWilds.AddState(
...
FSM_vars.state_machine_TheWilds.AddState(
    name="MAP PATH 5",
    execute_fn=lambda: handle_map_path(FSM_vars.TheWilds_Pathing_5),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheWilds_Pathing_5, FSM_vars.movement_handler
    )
    or (Map.IsMapReady() and Map.IsExplorable() and Party.IsPartyLoaded() and Map.IsInCinematic()),
    run_once=False,
)
...
FSM_vars.state_machine_TheWilds.AddState(
    name="MAP PATH 6",
    execute_fn=lambda: handle_map_path(FSM_vars.TheWilds_Pathing_6),
    exit_condition=lambda: Routines.Movement.IsFollowPathFinished(
        FSM_vars.TheWilds_Pathing_6, FSM_vars.movement_handler
    )
    or (Map.IsMapReady() and Map.IsExplorable() and Party.IsPartyLoaded() and Map.IsInCinematic()),
    run_once=False,
)
        ...
        if PyImGui.begin_tab_bar("MAINTABBAR"):
            ...
            if PyImGui.begin_tab_item("PROPHECIES"):
                ...
                state.radio_button_selected = PyImGui.radio_button(
                    "THE GREAT NORTHERN WALL", state.radio_button_selected, 0
                )
                ...
                state.radio_button_selected = PyImGui.radio_button(
                    "RIVERSIDE PROVINCE", state.radio_button_selected, 12
                )
                ...
                state.radio_button_selected = PyImGui.radio_button(
                    "ICE CAVE OF SORROW", state.radio_button_selected, 18
                )
                state.radio_button_selected = PyImGui.radio_button(
                    "IRON MINES OF MOLADUNE", state.radio_button_selected, 19
                )
            ...
            if PyImGui.begin_tab_item("FACTIONS"):
                PyImGui.spacing()
                state.radio_button_selected = PyImGui.radio_button(
                    "MINISTER CHO'S ESTATE", state.radio_button_selected, 24
                )
            ...
            if PyImGui.begin_tab_item("NIGHTFALL"):
                ...
                PyImGui.show_tooltip("REMEMBER TO ADD KOSS")
                state.radio_button_selected = PyImGui.radio_button(
                    "KODONUR CROSSROADS", state.radio_button_selected, 42
                )
                PyImGui.show_tooltip("REMEMBER TO ADD ZHED SHADOWHOOF")
                ...
                PyImGui.show_tooltip("REMEMBER TO ADD MASTER OF WHISPERS")
                state.radio_button_selected = PyImGui.radio_button(
                    "GRAND COURT OF SEBELKEH", state.radio_button_selected, 49
                )
                PyImGui.show_tooltip("REMEMBER TO ADD TAHLKORA")
                ...
                PyImGui.show_tooltip("REMEMBER TO ADD MELONNI")
                state.radio_button_selected = PyImGui.radio_button(
                    "GATE OF DESOLATION", state.radio_button_selected, 52
                )
                PyImGui.show_tooltip("REMEMBER TO ADD ZHED SHADOWHOOF")
            ...
            if PyImGui.begin_tab_item("EYE OF THE NORTH"):
                PyImGui.spacing()
                state.radio_button_selected = PyImGui.radio_button(
                    "FINDING THE BLOODSTONE", state.radio_button_selected, 57
                )
                state.radio_button_selected = PyImGui.radio_button(
                    "THE ELUSIVE GOLEMANCER", state.radio_button_selected, 58
                )
                ...
                state.radio_button_selected = PyImGui.radio_button(
                    "WARBAND OF BROTHERS", state.radio_button_selected, 61
                )
                state.radio_button_selected = PyImGui.radio_button(
                    "ASSAULT ON THE STRONGHOLD", state.radio_button_selected, 62
                )
                state.radio_button_selected = PyImGui.radio_button(
                    "CURSE OF THE NORNBEAR", state.radio_button_selected, 63
                )
                state.radio_button_selected = PyImGui.radio_button(
                    "BLOOD WASHES BLOOD", state.radio_button_selected, 64
                )
                state.radio_button_selected = PyImGui.radio_button("A GATE TOO FAR", state.radio_button_selected, 65)
                state.radio_button_selected = PyImGui.radio_button(
                    "DESTRUCTION'S DEPTHS", state.radio_button_selected, 66
                )
