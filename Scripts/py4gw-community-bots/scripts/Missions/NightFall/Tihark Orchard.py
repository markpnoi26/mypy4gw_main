...
from Core.routines_src.behaviourtrees_src.constants.lists import *
...
def AcquireZMission() -> BehaviorTree:
    return BT.Sequence(
        ...
        random_travel=False,
        hard_mode=True,
        children=[BT.MoveAndDialog((-206.20, -3480.20), 0x83DA01)],
    )
...
def TurnInMission() -> BehaviorTree:
    return BT.Sequence(
        ...
        random_travel=False,
        hard_mode=True,
        children=[BT.HandleAutoQuest((-708.29, -3207.30))],
    )
...
def DoMission() -> BehaviorTree:
    ...
    KILL_PATH = [[(-7808.27, 2277.65)], [(-5930.22, 3588.73)], [(-7981.76, 380.05)], [(-6094.06, -3301.68)]]
    return BT.Sequence(
        name='Killroute',
...
def get_execution_steps() -> list[tuple[str, Callable[[], BehaviorTree]]]:
    return [('Take Zaishen Mission', AcquireZMission), ('Do Mission', DoMission), ('Turn in Mission', TurnInMission)]
