...
from Core import Botting, ConsoleLog, Routines, Agent, Player, ImGui, Color, GLOBAL_CACHE
...
def draw_class_selector():
    ...
    if PyImGui.begin("Elite Tome Farmer - Configuration"):
        ...
        if target["boss_name"] and target["boss_name"] != "TODO":
            ...
            PyImGui.text_colored("Boss: Not configured", Color(255, 80, 80, 255).to_tuple_normalized())
        ...
        if not ready:
            ...
            PyImGui.text_colored("This class is not configured yet.", Color(255, 150, 50, 255).to_tuple_normalized())
        else:
