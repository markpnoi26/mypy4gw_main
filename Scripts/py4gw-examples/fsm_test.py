...
fsm.AddState(name="Add1", execute_fn=lambda: add_number(), transition_delay_ms=1000, exit_condition=lambda: True)

fsm.AddState(name="Add2", execute_fn=lambda: add_number(), transition_delay_ms=1000, exit_condition=lambda: True)

fsm.AddState(name="Add3", execute_fn=lambda: add_number(), transition_delay_ms=1000, exit_condition=lambda: True)

fsm.AddState(name="Add4", execute_fn=lambda: add_number(), transition_delay_ms=1000, exit_condition=lambda: True)

fsm.AddState(name="Add5", execute_fn=lambda: add_number(), transition_delay_ms=1000, exit_condition=lambda: True)
