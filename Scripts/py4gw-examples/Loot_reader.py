...
def DrawWindow():
    ...
    try:
        ...
        if PyImGui.begin(window_module.window_name, window_module.window_flags):
            ...
            Loot_Variables.include_model_id_in_tooltip = PyImGui.checkbox(
                "ModelID In Hovered Text", Loot_Variables.include_model_id_in_tooltip
            )
        ...
        PySystem.Console.Log(
            "LootConfigGUI", f"Error in {current_function}: {str(e)}", PySystem.Console.MessageType.Error
        )
        raise
