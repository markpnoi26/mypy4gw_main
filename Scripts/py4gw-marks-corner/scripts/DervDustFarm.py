...
from Core import *
from Core.Builds.Dervish.D_A.DervDustFarmer import DervBuildFarmStatus
from Core.Builds.Dervish.D_A.DervDustFarmer import DervDustFarmer
...
def main():
    ...
    TEXTURE = os.path.join(
        PySystem.Console.get_projects_path(), "Bots", "marks_coding_corner", "textures", "dust_art.png"
    )
