...
def setup_hero_ai_and_custom_builds(bot: Botting):
    ...
    if primary_profession != "Assassin" and use_assassin_skillbar:
        Player.SendFakeChat(ChatChannel.CHANNEL_WARNING, "You are not allowed to use this skill bar! Not Assassin main")
        yield
        return
...
def farm_dungeon(bot: Botting) -> None:
    ...
    bot.States.AddCustomState(
        clear_item_id_blacklist_and_attempt_open_chest_again, "Clears item blacklist, to open chest again"
    )
