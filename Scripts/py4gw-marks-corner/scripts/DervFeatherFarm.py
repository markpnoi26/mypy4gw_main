...
from Core import *
from Core.Builds.Dervish.D_A.DervFeatherFarmer import SENSALI_MODEL_IDS
from Core.Builds.Dervish.D_A.DervFeatherFarmer import DervBuildFarmStatus
from Core.Builds.Dervish.D_A.DervFeatherFarmer import DervFeatherFarmer
...
def main():
    ...
    TEXTURE = os.path.join(
        PySystem.Console.get_projects_path(), "Bots", "marks_coding_corner", "textures", "feather_art.png"
    )
