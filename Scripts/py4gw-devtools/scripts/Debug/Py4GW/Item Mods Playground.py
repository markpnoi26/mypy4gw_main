...
def _draw_filter(item_id: int):
    ...
    PyImGui.text_colored(GREEN if overall else RED, "ITEM MATCHES" if overall else "ITEM DOES NOT MATCH")
    PyImGui.text_colored(GREY, "(%s of %d criteria)" % ("all" if _f_mode_all else "any", len(results)))
