...
def tooltip():
    ...
    PyImGui.bullet_text(
        "Multi-Queue Tracking: Monitor specialized queues including Action, Loot, Merchant, and Salvage"
    )
            ...
            for queue_name in all_queues:
                if PyImGui.begin_tab_item(queue_name):
                    ...
                    if PyImGui.begin_child(
                        "InfoCurrentActions", size=(0, 100), border=True, flags=PyImGui.WindowFlags.HorizontalScrollbar
                    ):
                    ...
                    if PyImGui.begin_child(
                        "InfoHistoryActions", size=(0, 300), border=True, flags=PyImGui.WindowFlags.HorizontalScrollbar
                    ):
