...
def _ensure_ini() -> bool:
    ...
    FloatingIconVars.MAIN_INI_KEY = Settings(
        f"{FloatingIconVars.INI_PATH}/{FloatingIconVars.MAIN_INI_FILENAME}", "account"
    ).name
    FloatingIconVars.FLOATING_INI_KEY = Settings(
        f"{FloatingIconVars.INI_PATH}/{FloatingIconVars.FLOATING_INI_FILENAME}", "account"
    ).name
