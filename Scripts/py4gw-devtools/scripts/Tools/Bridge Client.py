...
def _apply_connection_settings():
    ...
    changed = new_host != STATE.daemon_host or new_port != STATE.daemon_port or new_token != STATE.auth_token
...
def _namespace_registry() -> dict[str, dict[str, Any]]:
    return {
        # Bridge namespace projections over Core source-of-truth libraries.
        "console": {"class": "Console", "target": _ConsoleBridge, "source": "Py4GW", "kind": "runtime"},
        "map": {"class": "Map", "target": Map, "source": "Core", "kind": "corelib"},
        "player": {"class": "Player", "target": Player, "source": "Core", "kind": "corelib"},
        "agent": {"class": "Agent", "target": Agent, "source": "Core", "kind": "corelib"},
        "agent_array": {"class": "AgentArray", "target": AgentArray, "source": "Core", "kind": "corelib"},
        "party_raw": {
            "class": "Party",
            "target": Party,
            "source": "Core",
            ...
            "note": "Historical bridge label; routes through Core.Party.",
        },
        "party_corelib": {
            "class": "Party",
            "target": Party,
            ...
            "kind": "corelib",
            "alias_of": "party_raw",
            "note": "Preferred clear alias for the Core Party source-of-truth library.",
        },
        "party_wrapper": {
            "class": "Party",
            "target": Party,
        ...
        "skill": {"class": "Skill", "target": Skill, "source": "Core", "kind": "corelib"},
        "skillbar_raw": {
            "class": "SkillBar",
            "target": SkillBar,
            "source": "Core",
            ...
            "note": "Historical bridge label; routes through Core.SkillBar.",
        },
        "skillbar_corelib": {
            "class": "SkillBar",
            "target": SkillBar,
            ...
            "note": "Preferred clear alias for the Core SkillBar source-of-truth library.",
        },
        "skillbar_wrapper": {
            "class": "SkillBar",
            "target": SkillBar,
        ...
        "inventory_raw": {
            ...
            "note": "Historical bridge label; routes through Core.Inventory.",
        },
        "inventory_corelib": {
            "class": "Inventory",
            "target": Inventory,
            ...
            "note": "Preferred clear alias for the Core Inventory source-of-truth library.",
        },
        "inventory_wrapper": {
            "class": "Inventory",
            "target": Inventory,
        ...
        "quest_raw": {
            ...
            "note": "Historical bridge label; routes through Core.Quest.",
        },
        "quest_corelib": {
            "class": "Quest",
            "target": Quest,
            ...
            "kind": "corelib",
            "alias_of": "quest_raw",
            "note": "Preferred clear alias for the Core Quest source-of-truth library.",
        },
        "quest_wrapper": {
            "class": "Quest",
            "target": Quest,
        ...
        "effects_raw": {
            ...
            "note": "Historical bridge label; routes through Core.Effects.",
        },
        "effects_corelib": {
            "class": "Effects",
            "target": Effects,
            ...
            "note": "Preferred clear alias for the Core Effects source-of-truth library.",
        },
        "effects_wrapper": {
            "class": "Effects",
            "target": Effects,
        ...
        "party": {
            "class": "GLOBAL_CACHE.Party",
            "target": GLOBAL_CACHE.Party,
            "source": "GLOBAL_CACHE",
            "kind": "cache",
        },
        "party.players": {
        ...
        "skillbar": {
            "class": "GLOBAL_CACHE.SkillBar",
            "target": GLOBAL_CACHE.SkillBar,
            "source": "GLOBAL_CACHE",
            "kind": "cache",
        },
        "inventory": {
            "class": "GLOBAL_CACHE.Inventory",
            "target": GLOBAL_CACHE.Inventory,
            "source": "GLOBAL_CACHE",
            "kind": "cache",
        },
        "quest": {
            "class": "GLOBAL_CACHE.Quest",
            "target": GLOBAL_CACHE.Quest,
            "source": "GLOBAL_CACHE",
            "kind": "cache",
        },
        "effects": {
            "class": "GLOBAL_CACHE.Effects",
            "target": GLOBAL_CACHE.Effects,
            "source": "GLOBAL_CACHE",
            "kind": "cache",
        },
        "shmem": {
            "class": "GLOBAL_CACHE.ShMem",
            "target": GLOBAL_CACHE.ShMem,
            "source": "GLOBAL_CACHE",
            "kind": "cache",
        },
    }
...
def _generic_targets() -> dict[str, tuple[str, Any]]:
    return {namespace: (str(info["class"]), info["target"]) for namespace, info in _namespace_registry().items()}
