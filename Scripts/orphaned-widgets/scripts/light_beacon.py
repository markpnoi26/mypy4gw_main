...
def _beam(x, y, gz, height, base_w, top_w, base_rgba, mid_rgba, top_rgba, alpha_mul, num_quads, mid_frac):
...
def _ground_profile(x, y, radius, lift):
    ...
    pts = [
        (x + math.cos(i / GROUND_SAMPLES * math.tau) * radius, y + math.sin(i / GROUND_SAMPLES * math.tau) * radius)
