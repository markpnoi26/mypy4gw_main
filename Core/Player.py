...
class Player:
    ...
    def SendRawDialog(dialog_id: int):
        ...
        ActionQueueManager().AddAction("ACTION", PlayerMethods.SendRawDialog, dialog_id)
    ...
    def BuySkill(skill_id: int):
        ...
        ActionQueueManager().AddAction("ACTION", PlayerMethods.SendSkillTrainerDialog, skill_id)
    ...
    def UnlockBalthazarSkill(skill_id: int, use_pvp_remap: bool = True):
        ...
        ActionQueueManager().AddAction("ACTION", PlayerMethods.SendBalthazarSkillUnlockDialog, skill_id, use_pvp_remap)
    ...
    def SendAutomaticDialog(button_number: int):
        ...
        try:
            available_buttons = [
                button for button in Dialog.get_active_dialog_buttons() if getattr(button, "dialog_id", 0) != 0
            ]
