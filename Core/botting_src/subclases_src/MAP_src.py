...
class _MAP:
    ...
    def _coro_enter_challenge(
        self, wait_for: int = 3000, target_map_id: int = 0, target_map_name: str = "", confirm_extra: bool = False
    ) -> Generator:
        from ...Routines import Routines
    ...
    def EnterChallenge(
        self, delay: int = 4500, target_map_id: int = 0, target_map_name: str = "", confirm_extra: bool = False
    ) -> None:
        self.ys_enter_challenge(
            wait_for=delay, target_map_id=target_map_id, target_map_name=target_map_name, confirm_extra=confirm_extra
        )
