...
class _Player:
    ...
    def delete_character(
        self, character_name: str, timeout_ms: int = 15000, log: bool = True
    ...
    def create_character(
        self, character_name: str, faction: str, class_name: str, timeout_ms: int = 15000, log: bool = True
    ) -> Generator[Any, Any, None]:
        from ...Routines import Routines
    ...
    def delete_and_create_character(
        self,
        character_name: str,
        ...
        yield from Routines.Yield.RerollCharacter.DeleteAndCreateCharacter(
            character_name, target_character_name, faction, class_name, timeout_ms, log
        )

    @_yield_step(label="RerollCharacter", counter_key="REROLL_CHARACTER")
    def reroll_character(
        self, target_character_name: str, timeout_ms: int = 15000, log: bool = True
    ) -> Generator[Any, Any, None]:
        from ...Routines import Routines
    ...
    def unlock_balthazar_skill(
        self, skill_id: int, use_pvp_remap: bool = True, log: bool = False
    ) -> Generator[Any, Any, None]:
        from ...Routines import Routines
