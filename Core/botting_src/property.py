...
class Property:
    ...
    def __init__(
        self, parent: "BotConfig", name: str, active: bool = True, extra_fields: Optional[Dict[str, Any]] = None
    ):
        self.parent = parent
        self.name = name
...
class ConfigProperties:
    def __init__(
        ...
        self.snap_to_ground_segments = Property(
            parent, "snap_to_ground_segments", extra_fields={"value": snap_to_ground_segments}
        )
...
class UpkeepData:
    def __init__(
        ...
        self.alcohol = Property(
            parent,
            "alcohol",
            active=alcohol_active,
            extra_fields={
        ...
        self.morale = Property(
            parent,
            "morale",
            active=morale_active,
            extra_fields={
                "target_morale": morale_target_level,
            },
        )

        self.armor_of_salvation = Property(
            parent,
            "armor_of_salvation",
            active=armor_of_salvation_active,
            extra_fields={
                "restock_quantity": armor_of_salvation_restock,
            },
        )
        self.essence_of_celerity = Property(
            parent,
            "essence_of_celerity",
            active=essence_of_celerity_active,
            extra_fields={
                "restock_quantity": essence_of_celerity_restock,
            },
        )
        self.grail_of_might = Property(
            parent,
            "grail_of_might",
            active=grail_of_might_active,
            extra_fields={
                "restock_quantity": grail_of_might_restock,
            },
        )
        self.blue_rock_candy = Property(
            parent,
            "blue_rock_candy",
            active=blue_rock_candy_active,
            extra_fields={
                "restock_quantity": blue_rock_candy_restock,
            },
        )
        self.green_rock_candy = Property(
            parent,
            "green_rock_candy",
            active=green_rock_candy_active,
            extra_fields={
                "restock_quantity": green_rock_candy_restock,
            },
        )
        self.red_rock_candy = Property(
            parent,
            "red_rock_candy",
            active=red_rock_candy_active,
            extra_fields={
                "restock_quantity": red_rock_candy_restock,
            },
        )
        self.birthday_cupcake = Property(
            parent,
            "birthday_cupcake",
            active=birthday_cupcake_active,
            extra_fields={
                "restock_quantity": birthday_cupcake_restock,
            },
        )
        self.slice_of_pumpkin_pie = Property(
            parent,
            "slice_of_pumpkin_pie",
            active=slice_of_pumpkin_pie_active,
            extra_fields={
                "restock_quantity": slice_of_pumpkin_pie_restock,
            },
        )
        self.bowl_of_skalefin_soup = Property(
            parent,
            "bowl_of_skalefin_soup",
            active=bowl_of_skalefin_soup_active,
            extra_fields={
                "restock_quantity": bowl_of_skalefin_soup_restock,
            },
        )
        self.build_ticker = Property(parent, "build_ticker", active=build_ticker_active)
        self.candy_apple = Property(
            parent,
            "candy_apple",
            active=candy_apple_active,
            extra_fields={
                "restock_quantity": candy_apple_restock,
            },
        )
        self.candy_corn = Property(
            parent,
            "candy_corn",
            active=candy_corn_active,
            extra_fields={
                "restock_quantity": candy_corn_restock,
            },
        )
        self.drake_kabob = Property(
            parent,
            "drake_kabob",
            active=drake_kabob_active,
            extra_fields={
                "restock_quantity": drake_kabob_restock,
            },
        )
        self.golden_egg = Property(
            parent,
            "golden_egg",
            active=golden_egg_active,
            extra_fields={
                "restock_quantity": golden_egg_restock,
            },
        )
        self.pahnai_salad = Property(
            parent,
            "pahnai_salad",
            active=pahnai_salad_active,
            extra_fields={
                "restock_quantity": pahnai_salad_restock,
            },
        )
        self.war_supplies = Property(
            parent,
            "war_supplies",
            active=war_supplies_active,
            extra_fields={
                "restock_quantity": war_supplies_restock,
            },
        )
        self.honeycomb = Property(
            parent,
            "honeycomb",
            active=honeycomb_active,
            extra_fields={
                "restock_quantity": honeycomb_restock,
            },
        )
        self.four_leaf_clover = Property(
            parent,
            "four_leaf_clover",
            active=four_leaf_clover_active,
            extra_fields={
                "restock_quantity": four_leaf_clover_restock,
            },
        )
        ...
        self.auto_inventory_management = Property(
            parent, "auto_inventory_management", active=auto_inventory_management_active
        )
        self.auto_loot = Property(parent, "auto_loot", active=auto_loot_active)

        self.identify_kits = Property(
            parent,
            "identify_kits",
            active=identify_kits_active,
            extra_fields={
                "restock_quantity": identify_kits_restock,
            },
        )

        self.salvage_kits = Property(
            parent,
            "salvage_kits",
            active=salvage_kits_active,
            extra_fields={
                "restock_quantity": salvage_kits_restock,
            },
        )

        self.leave_empty_inventory_slots = Property(
            parent,
            "leave_empty_inventory_slots",
            extra_fields={
                "value": leave_empty_inventory_slots,
            },
        )
