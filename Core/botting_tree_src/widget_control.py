...
class BottingTreeWidgetControlMixin:
    ...
    def ConfigureWidget(
        self: _BottingTreeWidgetControlHost, widget_name: str, enabled: bool, *, restore_on_stop: bool = True
    ) -> None:
    ...
    def GetWidgetSetEnabledTree(widget_name: str, enabled: bool, name: str | None = None) -> BehaviorTree:
        ...
        return BehaviorTree(BehaviorTree.ActionNode(name=node_name, action_fn=_set_widget_enabled, aftercast_ms=0))
