...
class InventoryCache:
    ...
    def GetInventorySpace(self):
        bags_to_check = [Bag_enum.Backpack.value, Bag_enum.Belt_Pouch.value, Bag_enum.Bag_1.value, Bag_enum.Bag_2.value]
    ...
    def SalvageFirst(self) -> bool:
        ...
        self._action_queue_manager.AddAction(
            "SALVAGE", self._inventory_instance.Salvage, salvage_kit_id, salvage_item_id
        )
    ...
    def MoveItem(self, item_id: int, bag_id: int, slot: int, quantity: int = 1):
        self._action_queue_manager.AddAction(
            "ACTION", self._inventory_instance.MoveItem, item_id, bag_id, slot, quantity
        )
