...
class CameraCache:
    ...
    def GetLookAtTarget(self):
        return (
            self._camera_instance.look_at_target.x,
            self._camera_instance.look_at_target.y,
            self._camera_instance.look_at_target.z,
        )
    ...
    def GetCameraPositionToGo(self):
        return (
            self._camera_instance.camera_pos_to_go.x,
            self._camera_instance.camera_pos_to_go.y,
            self._camera_instance.camera_pos_to_go.z,
        )

    def GetCameraPositionInverted(self):
        return (
            self._camera_instance.cam_pos_inverted.x,
            self._camera_instance.cam_pos_inverted.y,
            self._camera_instance.cam_pos_inverted.z,
        )

    def GetCameraPositionInvertedToGo(self):
        return (
            self._camera_instance.cam_pos_inverted_to_go.x,
            self._camera_instance.cam_pos_inverted_to_go.y,
            self._camera_instance.cam_pos_inverted_to_go.z,
        )

    def GetAtTargetToGo(self):
        return (
            self._camera_instance.look_at_to_go.x,
            self._camera_instance.look_at_to_go.y,
            self._camera_instance.look_at_to_go.z,
        )
