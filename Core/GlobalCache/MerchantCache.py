...
class TradingCache:
    ...
    class _Trader:
        ...
        def RequestQuote(self, item_id):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._merchant_instance.trader_request_quote, item_id
            )

        def RequestSellQuote(self, item_id):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._merchant_instance.trader_request_sell_quote, item_id
            )

        def BuyItem(self, item_id, cost):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._merchant_instance.trader_buy_item, item_id, cost
            )

        def SellItem(self, item_id, cost):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._merchant_instance.trader_sell_item, item_id, cost
            )
    ...
    class _Merchant:
        ...
        def BuyItem(self, item_id, cost):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._merchant_instance.merchant_buy_item, item_id, cost
            )

        def SellItem(self, item_id, cost):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._merchant_instance.merchant_sell_item, item_id, cost
            )
    ...
    class _Crafter:
        ...
        def CraftItem(self, item_id, cost, item_list, item_quantities):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._merchant_instance.crafter_buy_item, item_id, cost, item_list, item_quantities
            )
    ...
    class _Collector:
        ...
        def ExchangeItem(self, item_id, cost=0, item_list=[], item_quantities=[]):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._merchant_instance.collector_buy_item, item_id, cost, item_list, item_quantities
            )
