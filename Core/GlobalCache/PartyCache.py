import PyParty
from Core import Player, Map, Party
...
class PartyCache:
        ...
        def InvitePlayer(self, agent_id_or_name):
            ...
            if isinstance(agent_id_or_name, int):
                self._parent._action_queue_manager.AddAction(
                    "ACTION", self._parent._party_instance.InvitePlayer, agent_id_or_name
                )
                ...
                self._parent._action_queue_manager.AddAction(
                    "ACTION", Player.SendChatCommand, "invite " + require_real_name(agent_id_or_name)
                )
    ...
    class _Heroes:
        ...
        def UseSkill(self, hero_agent_id, slot, target_id):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._party_instance.UseHeroSkill, hero_agent_id, slot, target_id
            )

        def SetSkillAIEnabled(self, hero_agent_id, slot, enabled):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._party_instance.SetHeroSkillAIEnabled, hero_agent_id, slot, enabled
            )
        ...
        def SetHeroBehavior(self, hero_agent_id, behavior):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._party_instance.SetHeroBehavior, hero_agent_id, behavior
            )
    ...
    class _Henchmen:
        ...
        def AddHenchman(self, henchman_id):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._party_instance.AddHenchman, henchman_id
            )

        def KickHenchman(self, henchman_id):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._party_instance.KickHenchman, henchman_id
            )
    ...
    class _Pets:
        ...
        def SetPetBehavior(self, behavior, lock_target_id):
            self._parent._action_queue_manager.AddAction(
                "ACTION", self._parent._party_instance.SetPetBehavior, behavior, lock_target_id
            )
