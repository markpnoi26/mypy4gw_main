...
class GameTexture:
    ...
    def _build_state_uv(
        self, mode: TextureSliceMode, offset_x: float, offset_y: float
    ) -> dict[RegionFlags, Optional[UVRegion]]:
...
class ThemeTextures(Enum):
    ...
    ScrollGrab_Middle = ThemeTexture(
        (
            ...
            GameTexture(
                ...
                texture_size=(16, 16),
                element_size=(16, 2),
                state_map={TextureState.Normal: (0, 7)},
            ),
        )
    )
    ...
    Scroll_Bg = ThemeTexture(
        (
            ...
            GameTexture(
                ...
                texture_size=(16, 16),
                element_size=(16, 16),
                state_map={TextureState.Normal: (0, 0)},
            ),
        )
    )
    ...
    RightButton = ThemeTexture(
        (
            ...
            GameTexture(
                ...
                texture_size=(64, 16),
                element_size=(14, 16),
                state_map={TextureState.Normal: (1, 0)},
            ),
        )
    )
    ...
    Horizontal_ScrollGrab_Middle = ThemeTexture(
        (
            ...
            GameTexture(
                ...
                texture_size=(16, 16),
                element_size=(2, 16),
                state_map={TextureState.Normal: (7, 0)},
            ),
        )
    )
    ...
    Horizontal_ScrollGrab_Bottom = ThemeTexture(
        (
            ...
            GameTexture(
                ...
                texture_size=(16, 16),
                element_size=(7, 16),
                state_map={TextureState.Normal: (9, 0)},
            ),
        )
    )
    ...
    CircleButtons = ThemeTexture(
        (
            ...
            GameTexture(
                ...
                element_size=(32, 32),
                state_map={TextureState.Normal: (224, 96), TextureState.Active: (192, 96)},
            ),
        )
    )
    ...
    CollapsingHeader_Background = ThemeTexture(
        ...
        (
            StyleTheme.Guild_Wars,
            GameTexture(
                texture=os.path.join(TEXTURE_FOLDER, "ui_collapsing_header_background.png"),
                texture_size=(128, 32),
                mode=TextureSliceMode.THREE_HORIZONTAL,
            ),
        ),
    ...
    HardModeCompleted = ThemeTexture(
        (
            ...
            GameTexture(
                ...
                texture_size=(128, 64),
                element_size=(56, 56),
                state_map={TextureState.Normal: (56, 0)},
            ),
        ),
    )
