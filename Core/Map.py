...
from Core.py4gwcorelib_src.ActionQueue import ActionQueueManager
from Core.enums import outposts
...
class Map:
    ...
    def IsMapReady() -> bool:
        ...
        return Map.IsMapDataLoaded() and not Map.IsObservingMatch() and not Map.IsMapLoading()
    ...
    def TravelToDistrict(map_id: int, district: int = 0, district_number: int = 0) -> None:
        ...
        def _travel_to_district() -> bool:
            return MapMethods.Travel(
                map_id, _region_from_district(district), district_number, _language_from_district(district)
            )
    ...
    class Pregame:
        ...
        def LogoutToCharacterSelect():
            ...
            Returns: None
            """
            ActionQueueManager().AddAction("ACTION", MapMethods.LogouttoCharacterSelect)
