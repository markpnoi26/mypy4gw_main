...
from Core.native_src.internals.helpers import read_wstr
from Core.native_src.methods.DatFileMethods import read_dat_file_by_hash
...
_GRAMMAR_TAG_RE = re.compile(r'^\[(M|F|N|U|P|PM|PF|PN|m|u|null|proper|plur|sing)\]')
