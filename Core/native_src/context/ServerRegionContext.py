...
from ctypes import Structure, POINTER, c_uint32, c_float, c_void_p, c_wchar, c_uint8, c_uint16, c_int32, cast

from Core.native_src.context.InstanceInfoContext import InstanceInfo
...
class ServerRegion:
    ...
    def _update_ptr():
        ...
        ServerRegion._cached_ctx = cast(ptr, POINTER(ServerRegionStruct)).contents
