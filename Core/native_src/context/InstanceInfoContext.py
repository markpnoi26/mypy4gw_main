...
class InstanceInfo:
    ...
    def _update_ptr():
        ...
        if not ptr:
            ...
            return
        InstanceInfo._cached_ctx = cast(ptr, POINTER(InstanceInfoStruct)).contents
    ...
    def enable():
        ...
        PyCallback.PyCallback.Register(
            InstanceInfo._callback_name + ".Update",
            PyCallback.Phase.PreUpdate,
            InstanceInfo._update_ptr,
            priority=3,
    ...
    def disable():
        ...
        PyCallback.PyCallback.RemoveByName(InstanceInfo._callback_name + ".Update")
        InstanceInfo._ptr = 0
        InstanceInfo._cached_ctx = None
