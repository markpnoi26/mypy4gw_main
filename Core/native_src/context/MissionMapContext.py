...
class MissionMapContext:
    ...
    def _update_ptr():
        ...
        if not ptr:
            ...
            return
        MissionMapContext._cached_ctx = cast(ptr, POINTER(MissionMapContextStruct)).contents
    ...
    def enable():
        ...
        PyCallback.PyCallback.Register(
            MissionMapContext._callback_name + ".Update",
            PyCallback.Phase.PreUpdate,
            MissionMapContext._update_ptr,
            priority=99,
    ...
    def disable():
        ...
        PyCallback.PyCallback.RemoveByName(MissionMapContext._callback_name + ".Update")
