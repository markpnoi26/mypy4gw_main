...
EVENT_TYPE_DESCRIPTORS: dict[EventType, CombatEventDescriptor] = {
    EventType.SKILL_ACTIVATED: CombatEventDescriptor(
        "Skill Activated",
        "CAST",
        "skill",
        EventFieldRole.CASTER,
        EventFieldRole.SKILL_ID,
        EventFieldRole.TARGET,
        EventFieldRole.UNUSED,
    ),
    EventType.ATTACK_SKILL_ACTIVATED: CombatEventDescriptor(
    ...
    EventType.SKILL_STOPPED: CombatEventDescriptor(
        "Skill Stopped",
        "STOPPED",
        "skill",
        EventFieldRole.CASTER,
    ...
    EventType.SKILL_FINISHED: CombatEventDescriptor(
        "Skill Finished",
        "FINISHED",
        "skill",
        EventFieldRole.CASTER,
    ...
    EventType.ATTACK_SKILL_FINISHED: CombatEventDescriptor(
    ...
    EventType.INTERRUPTED: CombatEventDescriptor(
        "Interrupted",
        "INTERRUPT",
        "skill",
        EventFieldRole.AGENT,
        EventFieldRole.SKILL_ID,
        EventFieldRole.UNUSED,
        EventFieldRole.UNUSED,
    ),
    EventType.INSTANT_SKILL_ACTIVATED: CombatEventDescriptor(
        "Instant Skill Activated",
        "INSTANT",
        "skill",
        EventFieldRole.CASTER,
        EventFieldRole.SKILL_ID,
    ...
    EventType.ATTACK_SKILL_STOPPED: CombatEventDescriptor(
        "Attack Skill Stopped",
        "ATK_STOP",
        "skill",
        EventFieldRole.CASTER,
        EventFieldRole.SKILL_ID,
    ...
    EventType.ATTACK_STARTED: CombatEventDescriptor(
        "Attack Started",
        "ATTACK",
        "attack",
        EventFieldRole.ATTACKER,
        EventFieldRole.UNUSED,
        EventFieldRole.TARGET,
        EventFieldRole.UNUSED,
    ),
    EventType.ATTACK_STOPPED: CombatEventDescriptor(
        "Attack Stopped",
        "ATK_STOP",
        "attack",
        EventFieldRole.ATTACKER,
    ...
    EventType.MELEE_ATTACK_FINISHED: CombatEventDescriptor(
    ...
    EventType.DISABLED: CombatEventDescriptor(
        "Disabled",
        "DISABLED",
        "state",
        EventFieldRole.AGENT,
        EventFieldRole.DISABLED_FLAG,
        EventFieldRole.UNUSED,
        EventFieldRole.UNUSED,
    ),
    EventType.KNOCKED_DOWN: CombatEventDescriptor(
        "Knocked Down",
        "KD",
        "state",
        EventFieldRole.AGENT,
        EventFieldRole.UNUSED,
        EventFieldRole.UNUSED,
        EventFieldRole.DURATION_SECONDS,
    ),
    EventType.CASTTIME: CombatEventDescriptor(
        "Cast Time",
        "CASTTIME",
        "state",
        EventFieldRole.CASTER,
    ...
    EventType.DAMAGE: CombatEventDescriptor(
        "Damage",
        "DMG",
        "damage",
        EventFieldRole.TARGET,
        EventFieldRole.SKILL_ID,
        EventFieldRole.SOURCE,
        EventFieldRole.DAMAGE_FRACTION,
        "For damage packets, agent_id is the target and target_id is the source.",
    ),
    EventType.CRITICAL: CombatEventDescriptor(
        "Critical Damage",
        "CRIT",
        "damage",
        EventFieldRole.TARGET,
    ...
    EventType.ARMOR_IGNORING: CombatEventDescriptor(
        "Armor Ignoring",
        "ARMOR_IGN",
        "damage",
        EventFieldRole.TARGET,
    ...
    EventType.HEALING: CombatEventDescriptor(
        "Healing",
        "HEAL",
        "healing",
        EventFieldRole.TARGET,
        EventFieldRole.SKILL_ID,
        EventFieldRole.SOURCE,
        EventFieldRole.HEAL_FRACTION,
    ),
    EventType.EFFECT_APPLIED: CombatEventDescriptor(
        "Effect Applied",
        "EFFECT_ON",
        "effect",
        EventFieldRole.AGENT,
        EventFieldRole.EFFECT_ID,
        EventFieldRole.UNUSED,
        EventFieldRole.UNUSED,
    ),
    EventType.EFFECT_REMOVED: CombatEventDescriptor(
        "Effect Removed",
        "EFFECT_OFF",
        "effect",
        EventFieldRole.AGENT,
    ...
    EventType.EFFECT_ON_TARGET: CombatEventDescriptor(
        "Effect On Target",
        "EFFECT_HIT",
        "effect",
        EventFieldRole.CASTER,
    ...
    EventType.EFFECT_RENEWED: CombatEventDescriptor(
        "Effect Renewed",
        "EFFECT_RE",
        "effect",
        EventFieldRole.AGENT,
    ...
    EventType.ENERGY_GAINED: CombatEventDescriptor(
        "Energy Gained",
        "E_GAIN",
        "energy",
        EventFieldRole.AGENT,
        EventFieldRole.UNUSED,
        EventFieldRole.UNUSED,
        EventFieldRole.ENERGY_GAINED,
    ),
    EventType.ENERGY_SPENT: CombatEventDescriptor(
        "Energy Spent",
        "E_SPENT",
        "energy",
        EventFieldRole.AGENT,
        EventFieldRole.UNUSED,
        EventFieldRole.UNUSED,
        EventFieldRole.ENERGY_SPENT,
    ),
    EventType.SKILL_DAMAGE: CombatEventDescriptor(
        "Skill Damage",
        "SKILL_DMG",
        "damage",
        EventFieldRole.TARGET,
    ...
    EventType.SKILL_ACTIVATE_PACKET: CombatEventDescriptor(
        "Skill Activate Packet",
        "SKILL_PKT",
        "skill",
        EventFieldRole.CASTER,
        EventFieldRole.SKILL_ID,
    ...
    EventType.SKILL_RECHARGE: CombatEventDescriptor(
        "Skill Recharge",
        "RECHARGE",
        "recharge",
        EventFieldRole.AGENT,
        EventFieldRole.SKILL_ID,
        EventFieldRole.UNUSED,
        EventFieldRole.RECHARGE_MS,
    ),
    EventType.SKILL_RECHARGED: CombatEventDescriptor(
        "Skill Recharged",
        "READY",
        "recharge",
        EventFieldRole.AGENT,
