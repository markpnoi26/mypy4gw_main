...
class Key(Enum):
    ...
    GamepadRB = VK_GAMEPAD_RIGHT_SHOULDER
    VK_GAMEPAD_LEFT_SHOULDER = 0xC8
    GamepadLB = VK_GAMEPAD_LEFT_SHOULDER
    VK_GAMEPAD_LEFT_TRIGGER = 0xC9
    GamepadLT = VK_GAMEPAD_LEFT_TRIGGER
    VK_GAMEPAD_RIGHT_TRIGGER = 0xCA
    GamepadRT = VK_GAMEPAD_RIGHT_TRIGGER
    ...
    GamepadLThumb = VK_GAMEPAD_LEFT_THUMBSTICK_BUTTON
    VK_GAMEPAD_RIGHT_THUMBSTICK_BUTTON = 0xD2
    GamepadRThumb = VK_GAMEPAD_RIGHT_THUMBSTICK_BUTTON
    VK_GAMEPAD_LEFT_THUMBSTICK_UP = 0xD3
    GamepadLThumbUp = VK_GAMEPAD_LEFT_THUMBSTICK_UP
    VK_GAMEPAD_LEFT_THUMBSTICK_DOWN = 0xD4
    GamepadLThumbDown = VK_GAMEPAD_LEFT_THUMBSTICK_DOWN
    VK_GAMEPAD_LEFT_THUMBSTICK_RIGHT = 0xD5
    GamepadLThumbRight = VK_GAMEPAD_LEFT_THUMBSTICK_RIGHT
    VK_GAMEPAD_LEFT_THUMBSTICK_LEFT = 0xD6
    GamepadLThumbLeft = VK_GAMEPAD_LEFT_THUMBSTICK_LEFT
    VK_GAMEPAD_RIGHT_THUMBSTICK_UP = 0xD7
    GamepadRThumbUp = VK_GAMEPAD_RIGHT_THUMBSTICK_UP
    VK_GAMEPAD_RIGHT_THUMBSTICK_DOWN = 0xD8
    GamepadRThumbDown = VK_GAMEPAD_RIGHT_THUMBSTICK_DOWN
    VK_GAMEPAD_RIGHT_THUMBSTICK_RIGHT = 0xD9
    GamepadRThumbRight = VK_GAMEPAD_RIGHT_THUMBSTICK_RIGHT
    VK_GAMEPAD_RIGHT_THUMBSTICK_LEFT = 0xDA
    GamepadRThumbLeft = VK_GAMEPAD_RIGHT_THUMBSTICK_LEFT
