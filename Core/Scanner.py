...
class Scanner:
    ...
    def FindAssertion(assertion_file: str, assertion_msg: str, line_number: int = 0, offset: int = 0) -> int:
        ...
        Returns the found address or 0.
        """
        return Scanner._Scanner.FindAssertion(assertion_file, assertion_msg, line_number, offset)
    ...
    @staticmethod
    def FunctionFromNearCall(call_instruction_address: int, check_valid_ptr: bool = True) -> int:
        """
