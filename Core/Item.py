...
from Core.enums_src.GameData_enums import Attribute, DyeColor, Gender
from Core.enums_src.Item_enums import DAMAGE_RANGES, ItemType, Rarity
from Core import mods_core
from Core.mods_types import ModifierIdentifier as ModId
...
class Item:
    ...
    def GetDyeColor(item_id: int) -> int:
        ...
        Returns: int: The Core.DyeColor equivalent value or zero (None).
        """
...
KNOWN_SUMMONING_STONE_CREATURE_MODEL_IDS = frozenset(
    {
        ...
        8028,  # Legionnaire
        9055,
        9076,  # Tengu Support Flare - Warrior
        9056,
        9077,  # Tengu Support Flare - Ranger
        9058,
        9079,  # Tengu Support Flare - Monk
        9060,
        9081,  # Tengu Support Flare - Mesmer
        9062,
        9083,  # Tengu Support Flare - Ritualist
        9065,
        9086,  # Tengu Support Flare - Assassin
        9067,
        9088,  # Tengu Support Flare - Elementalist
        9069,
        9090,  # Tengu Support Flare - Necromancer
