...
if TYPE_CHECKING:
    ...
    class _BTProxy:
        ...
        def __getattr__(self, name: str) -> Any:
            ...
            """
            module = importlib.import_module('Core.routines_src.BehaviourTrees')
...
class BTPlayer:
    ...
    def InteractAgent(agent_id: int, log: bool = False) -> BehaviorTree:
        ...
        tree: BehaviorTree.ActionNode = BehaviorTree.ActionNode(
            name="InteractAgent", action_fn=lambda: _interact_agent(agent_id), aftercast_ms=aftercast_ms
        )
        ...
        tree: BehaviorTree.SequenceNode = BehaviorTree.SequenceNode(
            children=[
                BehaviorTree.ActionNode(
                    name="GetTargetID", action_fn=lambda node: _get_target_id(node), aftercast_ms=100
                ),
    ...
    def ChangeTarget(agent_id: int, log: bool = False) -> BehaviorTree:
        ...
        tree: BehaviorTree.ActionNode = BehaviorTree.ActionNode(
            name="ChangeTarget", action_fn=lambda: _change_target(), aftercast_ms=250
        )
        return BehaviorTree(tree)
    ...
    def SendDialog(dialog_id: str | int, log: bool = False) -> BehaviorTree:
        ...
        tree: BehaviorTree.ActionNode = BehaviorTree.ActionNode(
            name="SendDialog", action_fn=lambda: _send_dialog(dialog_id), aftercast_ms=300
        )
        return BehaviorTree(tree)
    ...
    def SetTitle(title_id: int, log: bool = False) -> BehaviorTree:
        ...
        tree: BehaviorTree.ActionNode = BehaviorTree.ActionNode(
            name="SetTitle", action_fn=lambda: _set_title(title_id), aftercast_ms=300
        )
        return BehaviorTree(tree)
    ...
    def SendChatCommand(command: str, log: bool = False) -> BehaviorTree:
        ...
        tree: BehaviorTree.ActionNode = BehaviorTree.ActionNode(
            name="SendChatCommand", action_fn=lambda: _send_chat_command(command), aftercast_ms=300
        )
        return BehaviorTree(tree)
    ...
    def BuySkill(skill_id: int, log: bool = False) -> BehaviorTree:
        ...
        tree: BehaviorTree.ActionNode = BehaviorTree.ActionNode(
            name="BuySkill", action_fn=lambda: _buy_skill(skill_id), aftercast_ms=300
        )
        return BehaviorTree(tree)
    ...
    def Resign(log: bool = False) -> BehaviorTree:
        ...
        tree: BehaviorTree.ActionNode = BehaviorTree.ActionNode(
            name="Resign", action_fn=lambda: _resign(), aftercast_ms=250
        )
        return BehaviorTree(tree)
    ...
    def SendChatMessage(channel: str, message: str, log: bool = False) -> BehaviorTree:
        ...
        tree: BehaviorTree.ActionNode = BehaviorTree.ActionNode(
            name="SendChatMessage", action_fn=lambda: _send_chat_message(channel, message), aftercast_ms=300
        )
        return BehaviorTree(tree)
    ...
    def PrintMessageToConsole(source: str, message: str, message_type: int = Console.MessageType.Info) -> BehaviorTree:
        ...
        tree: BehaviorTree.ActionNode = BehaviorTree.ActionNode(
            name="PrintMessageToConsole",
            action_fn=lambda: _print_message_to_console(source, message, message_type),
            aftercast_ms=100,
        )
        return BehaviorTree(tree)
    ...
    def LoadBlackboardValue(
        ...
        def _load_blackboard_value(node: BehaviorTree.Node) -> BehaviorTree.NodeState:
            ...
            if source_key not in node.blackboard:
                ...
                return BehaviorTree.NodeState.FAILURE if fail_if_missing else BehaviorTree.NodeState.SUCCESS
