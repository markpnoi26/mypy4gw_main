...
def add_path_to_target_state(
    ...
    *,
    ...
    from Core import Agent, Player, Range, Utils
...
def add_auto_path_state(
    ...
    *,
    ...
    from Core import Agent, GLOBAL_CACHE, Map, Player, Routines, Utils
    ...
    def _recovery_blocking() -> bool:
        try:
            return bool(
                _is_player_dead() or Routines.Checks.Party.IsPartyWiped() or GLOBAL_CACHE.Party.IsPartyDefeated()
            )
        except Exception:
