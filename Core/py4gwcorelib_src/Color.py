...
class Color:
    ...
    def from_json(cls, data: dict[str, int]) -> "Color":
        ...
        return cls(data.get("r", 255), data.get("g", 255), data.get("b", 255), data.get("a", 255))
    ...
    def random(cls, a: int = 255) -> "Color":
        ...
        return cls(r=random.randint(0, 255), g=random.randint(0, 255), b=random.randint(0, 255), a=a)
...
class ColorPalette(Enum):
    ...
    def _member_map_lower(cls) -> dict[str, 'ColorPalette']:
        ...
        return {cls._normalize_name(member_name): member for member_name, member in cls.__members__.items()}
