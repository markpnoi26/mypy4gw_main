...
class Rule:
    ...
    def is_empty(self) -> bool:
        ...
        return not (
            ...
            or self.model_ids
            or self.dye_colors
            or self.salvages_into
            or self.name_contains
            or self.rarities
            or self.max_requirement is not None
            or self.min_value is not None
            or self.min_damage is not None
            or self.damage_types
        )
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "dye_colors": list(self.dye_colors),
            "salvages_into": list(self.salvages_into),
            ...
            "mark_recolor": self.mark_recolor,
            "mark_color": list(self.mark_color),
            "mark_blank": self.mark_blank,
            "mark_beacon": self.mark_beacon,
    ...
    def from_dict(raw: dict) -> "Rule":
        ...
        return Rule(
            ...
            item_types=ints("item_types"),
            model_ids=ints("model_ids"),
            dye_colors=ints("dye_colors"),
            salvages_into=ints("salvages_into"),
            ...
            requirement_attribute=(
                None if raw.get("requirement_attribute") is None else int(raw["requirement_attribute"])
            ),
