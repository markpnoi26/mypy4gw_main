...
class ProfileScope:
    ...
    def __init__(self, timings: dict, category: str, name: str, cprofiler: Optional[cProfile.Profile] = None):
...
class ProfilingRegistry:
    ...
    def scope(self, category: str, name: str) -> ProfileScope:
        return ProfileScope(self.timings, category, name, self.cprofile_targets.get(name))
