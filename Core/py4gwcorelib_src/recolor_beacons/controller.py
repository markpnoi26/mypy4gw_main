...
class RecolorBeacons:
    ...
    def _clear_output(self) -> None:
        ...
        if self._pushed:
            try:
                from Core.AgentRecolor import AgentRecolor
    ...
    def status(self) -> dict:
        return {
            ...
            "filters": len(self.marking_filters()),
            "recoloured": len(self._pushed),
    ...
    def register(self) -> None:
        ...
        try:
            ...
            PyCallback.PyCallback.Register(
                _CB_DATA, PyCallback.Phase.Data, self._data_pass, priority=99, context=PyCallback.Context.Update
            )
            PyCallback.PyCallback.Register(
                _CB_DRAW, PyCallback.Phase.Update, self._draw_pass, priority=99, context=PyCallback.Context.Draw
            )
