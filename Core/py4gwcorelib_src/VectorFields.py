...
class VectorFields:
    ...
    def add_agent_array(
        self, array_name, agent_array, radius, is_dangerous=True, body_radius=0.0, agent_radius_fn=None
    ):
        """
    ...
    def generate_escape_vector(self, agent_arrays, custom_repulsion_positions=None, custom_attraction_positions=None):
        ...
        for agent_array in agent_arrays:
            ...
            self.add_agent_array(
                name, array, radius, is_dangerous, body_radius=body_radius, agent_radius_fn=agent_radius_fn
            )
...
class BumperCarVectorFields:
    ...
    def compute_vector(self):
        ...
        for body in self._bodies:
            collision_vector = self._add(collision_vector, self._collision_response(body))
