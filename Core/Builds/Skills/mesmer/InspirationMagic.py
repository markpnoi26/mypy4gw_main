...
class InspirationMagic:
    ...
    def Drain_Enchantment(
        ...
        *,
        ...
        from Core import Agent, AgentArray, Player, Range, Routines, Utils
        ...
        enchanted_enemies = AgentArray.Filter.ByCondition(
            enemy_array,
            lambda agent_id: (Agent.IsValid(agent_id) and not Agent.IsDead(agent_id) and Agent.IsEnchanted(agent_id)),
        )
    ...
    def Power_Drain(
        ...
        *,
        ...
        from Core import Agent, Player, Range, Routines
