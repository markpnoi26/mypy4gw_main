...
class AgentArray:
    ...
    def GetAgentArray() -> list[int]:
        ...
        from Core.native_src.ShMem.SysShaMem import (
            SystemShaMemMgr,
            SharedMemoryHeader,
            AgentArraySHMemStruct,
            AgentArraySHMemWrapper,
        )
    ...
    class Sort:
        ...
        def ByAttribute(agent_array, attribute, descending=False):
            ...
            return AgentArray.Sort.ByCondition(
                agent_array, condition_func=lambda agent_id: getattr(Agent, attribute)(agent_id), reverse=descending
            )
        ...
        def ByDistance(agent_array, pos, descending=False):
            ...
            return AgentArray.Sort.ByCondition(
                agent_array,
                condition_func=lambda agent_id: Utils.Distance(Agent.GetXY(agent_id), (pos[0], pos[1])),
                reverse=descending,
            )
        ...
        def ByHealth(agent_array, descending=False):
            ...
            if agent_array is None:
                return []
            return AgentArray.Sort.ByCondition(
                agent_array, condition_func=lambda agent_id: Agent.GetHealth(agent_id), reverse=descending
            )
