...
against the gate.
    ...
    python test/breakage.py
    python test/breakage.py --vs-upstream    # also ask whether upstream's copy loads
"""
...
def render(results, index, verdicts) -> str:
    ...
    lines.append("")
    lines.append("Generated by `python test/breakage.py`. Nothing here is fixed automatically.")
    lines.append("")
