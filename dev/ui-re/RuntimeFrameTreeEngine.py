...
class _EngineUIState:
    def __init__(self) -> None:
        ...
        self.hash_names_path = "Core\\frame_hash_names.json"
        self.descriptors_path = "Core\\frame_child_descriptors.json"
        self.legacy_aliases_path = "Core\\frame_aliases.json"
