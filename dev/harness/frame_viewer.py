...
from Core import UIManager, Color, ColorPalette
...
class ViewerState:
    ...
    def load_identity_tables(self):
        ...
        Core/FrameTree, and the reverse path maps are owned by the
        Frame class.
        """
        try:
            from Core.FrameTree import FRAME_NAMES
            from Core.FrameTree import alias_by_path, key_by_path
        except Exception as exc:
