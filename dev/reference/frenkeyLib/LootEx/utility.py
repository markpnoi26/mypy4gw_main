...
from dev.reference.frenkeyLib.LootEx import item_configuration, enum
from dev.reference.frenkeyLib.LootEx import models
from dev.reference.frenkeyLib.LootEx.enum import ItemAction, ItemCategory, ModifierIdentifier, ModifierValueArg
from dev.reference.frenkeyLib.LootEx.item_configuration import ItemConfiguration

import importlib

from dev.reference.frenkeyLib.LootEx.models import ModifierInfo, Rune, WeaponMod
from Core import Item, UIManager
import Core
from Core.ItemArray import ItemArray
from Core.Py4GWcorelib import ConsoleLog, Utils
from Core.enums import Attribute, Console, DamageType, ItemType, ModelID, NumberPreference, Profession, Rarity, DyeColor, ServerLanguage
...
class Util:
    ...
    @staticmethod
    def GetZeroFilledBags(start_bag: Core.Bag, end_bag: Core.Bag) -> tuple[list[int], dict[Core.Bag, int]]:
        inventory = []
        bag_sizes = {}
