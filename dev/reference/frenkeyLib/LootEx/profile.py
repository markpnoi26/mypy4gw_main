from dev.reference.frenkeyLib.LootEx import skin_rule, filter, messaging
from dev.reference.frenkeyLib.LootEx.filter import Filter
from dev.reference.frenkeyLib.LootEx.weapon_rule import WeaponRule
from dev.reference.frenkeyLib.LootEx.item_configuration import *
from Core import Console
from Core import JsonFactory
from Core.Py4GWcorelib import ConsoleLog
from Core.enums import DyeColor
...
class Profile:
    ...
    def save(self):
        from dev.reference.frenkeyLib.LootEx.settings import settings_store
