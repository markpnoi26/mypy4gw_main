...
from Core.ImGui_src.types import Alignment, ControlAppearance, TextDecorator
from Core.py4gwcorelib_src.WidgetManager import get_widget_handler
from dev.reference.frenkeyLib.Core.iterable import chunked
from dev.reference.frenkeyLib.Core.utility import string_similarity
from dev.reference.frenkeyLib.Core.gui import GUI
from dev.reference.frenkeyLib.Core import ex_style, texture_map
from dev.reference.frenkeyLib.LootEx import skin_rule, loot_handling, settings, price_check, utility, cache, ui_manager_extensions, inventory_handling, models, messaging
from dev.reference.frenkeyLib.LootEx.crafting import CraftingAction
from dev.reference.frenkeyLib.LootEx.data import Data
from dev.reference.frenkeyLib.LootEx.data_collection import DataCollector
from dev.reference.frenkeyLib.LootEx.enum import CHARACTER_INVENTORY, ITEM_CONVERSIONS, XUNLAI_STORAGE, ActionModsType, ItemAction, ItemCategory, ItemSubCategory, MaterialType, MerchantType, ModType, SalvageOption
from dev.reference.frenkeyLib.LootEx.item_configuration import ConfigurationCondition
from dev.reference.frenkeyLib.LootEx.filter import Filter
from dev.reference.frenkeyLib.LootEx.profile import Profile
from dev.reference.frenkeyLib.LootEx.texture_scraping_models import ScrapedItem
from dev.reference.frenkeyLib.LootEx.trading import ActionType, TraderAction, add_ingredients_to_buy
from dev.reference.frenkeyLib.LootEx.ui_manager_extensions import UIManagerExtensions
from Core import *
...
class UI:
    ...
    def __init__(self):
        ...
        from dev.reference.frenkeyLib.LootEx.settings import Settings
                    ...
                    if ImGui.begin_table("SummaryCraftingQueueTable", 2, PyImGui.TableFlags.NoSavedSettings, 0, summary_height):
                        ...
                        if ImGui.begin_child("ActionsCraftingCost", (0, 0), False, PyImGui.WindowFlags.NoScrollbar | PyImGui.WindowFlags.NoScrollWithMouse):
                            ...
                            if ImGui.button("Buy Conset Evenly", 150, 30):        
                                from dev.reference.frenkeyLib.LootEx.crafting import get_missing_materials_to_evenout
