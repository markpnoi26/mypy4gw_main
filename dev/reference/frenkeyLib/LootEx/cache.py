...
from Core.enums import Attribute, DyeColor, ItemType, ModelID, Rarity
...
from dev.reference.frenkeyLib.LootEx.enum import ModType, ModifierIdentifier
from dev.reference.frenkeyLib.LootEx.models import ItemModifiersInformation, RuneModInfo, WeaponModInfo

class Cached_Item:
    def __init__(self, item_id: int, slot: int = -1):
        from dev.reference.frenkeyLib.LootEx import utility, models, enum, skin_rule, weapon_rule
    ...
    def GetModsFromModifiers(self) -> tuple[list[RuneModInfo], list[WeaponModInfo]]:
        from dev.reference.frenkeyLib.LootEx.enum import ModifierIdentifier
