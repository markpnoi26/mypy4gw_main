...
from Core.enums_src.GameData_enums import Attribute, Profession
from Core.enums_src.Item_enums import ItemType, Rarity
from Core.enums_src.Model_enums import ModelID
from Core.enums_src.Region_enums import ServerLanguage
...
from dev.reference.frenkeyLib.LootEx import messaging, ui_manager_extensions, utility
from dev.reference.frenkeyLib.LootEx.cache import Cached_Item
from dev.reference.frenkeyLib.LootEx.enum import ALL_BAGS, ITEM_TEXTURE_FOLDER, ModType
from dev.reference.frenkeyLib.LootEx.models import Item, ItemModifiersInformation, ItemsByType, WeaponMod
...
class CollectionEntry(Item):
    ...
    def get_cleaned_item_name(self, item_name : str, server_language: ServerLanguage) -> str:  
        ...
        from dev.reference.frenkeyLib.LootEx.models import RuneModInfo, WeaponModInfo
