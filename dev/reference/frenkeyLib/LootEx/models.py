...
from dev.reference.frenkeyLib.Core.utility import get_image_name
from dev.reference.frenkeyLib.LootEx import enum
from dev.reference.frenkeyLib.LootEx.enum import INVALID_NAMES, Campaign, EnemyType, MaterialType, ModType, ModifierIdentifier, ModifierValueArg, ModsModels
from Core.GlobalCache import GLOBAL_CACHE
from Core.Py4GWcorelib import ConsoleLog
from Core.enums import Attribute, Console, DamageType, ItemType, ModelID, Profession, Rarity, ServerLanguage
...
def get_server_language() -> ServerLanguage:
    from dev.reference.frenkeyLib.LootEx import settings
...
class Ingredient:
    ...
    def get_item_data(self):
        from dev.reference.frenkeyLib.LootEx.utility import Util
...
class WeaponModInfo(BaseModInfo):       
    ...
    def get_from_modifiers(modifiers: list[tuple[int, int, int]], item_type: ItemType = ItemType.Unknown, model_id: int = -1) -> list["WeaponModInfo"] | None:
        ...
        for weapon_mod in potential_weapon_mods:
            ...
            from dev.reference.frenkeyLib.LootEx import utility
...
class ItemModifiersInformation:
    def __init__(self):
        from dev.reference.frenkeyLib.LootEx.models import WeaponModInfo, RuneModInfo        
    ...
    def populate_from_modifiers(self, modifiers: list[ItemModifier], item_type: ItemType, model_id: int, is_inscribable: bool) -> "ItemModifiersInformation":
        from dev.reference.frenkeyLib.LootEx.models import WeaponModInfo
