...
from dev.reference.frenkeyLib.LootEx.enum import MAX_CHARACTER_GOLD, MAX_VAULT_GOLD, ActionState, MerchantType
from dev.reference.frenkeyLib.LootEx.models import Ingredient
...
def add_ingredients_to_buy(all_ingredients: list[Ingredient]) -> None:
    from dev.reference.frenkeyLib.LootEx.inventory_handling import InventoryHandler
