...
from Core.enums_src.GameData_enums import Attribute, Profession, DyeColor
...
from dev.reference.frenkeyLib.ItemHandling.Items.ItemData import ITEM_DATA, ItemData
...
from Core.native_src.internals.encoded_strings import GWStringEncoded
...
class ItemSnapshot:
    ...
    def from_item_id(cls, item_id: int, item_instance: Optional[PyItem] = None) -> Optional['ItemSnapshot']:
        # Reforged: items may be dicts from PyInventory.GetItems() — handled by Core monkey-patch
