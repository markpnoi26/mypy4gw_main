...
from Core.routines_src.behaviourtrees_src.player import BT
...
from Core.enums import PlayerStatus
...
def _flag_heroai_accounts_by_party_position(
    ...
    *,
    ...
    def _apply_flag(_node: BehaviorTree.Node) -> BehaviorTree.NodeState:
        from Core import GLOBAL_CACHE, Agent, Party
...
def CreateParty(
    ...
    def _need_summon_accounts() -> bool:
        from Core.routines_src.behaviourtrees_src.shared import _account_emails_not_on_same_map_as_local
        return len(_account_emails_not_on_same_map_as_local()) > 0

    def _need_invite_accounts() -> bool:
        from Core.routines_src.behaviourtrees_src.shared import _account_emails_on_same_map_as_local
