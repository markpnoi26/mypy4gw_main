...
MODULAR_DIR = REPO_ROOT / "Core" / "modular"
MODULAR_CORE_DIR = REPO_ROOT / "Core" / "routines_src" / "behaviourtrees_src" / "modular_core"
...
def _check_runner_contract() -> list[str]:
    ...
    if "from Core.BottingTree import BottingTree" not in text:
