...
from Core.modular.domain.target_registry import ENEMY_TARGETS
from Core.modular.domain.target_registry import GADGET_TARGETS
from Core.modular.domain.target_registry import NPC_TARGETS
...
def _target_registry_file_hint() -> str:
    return "Core/modular/domain/target_registry.py"
