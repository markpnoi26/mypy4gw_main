...
class MerchantModule:
    ...
    def draw_merchants_bottom_strip(self):
        ...
        table_flags = PyImGui.TableFlags.BordersInnerV | PyImGui.TableFlags.NoPadOuterX
        ...
        if PyImGui.begin("MerchButtonsWindow", window_flags):
            if PyImGui.begin_table("MerchButtonsTable", 4, table_flags):
                ...
                if game_button(
                    IconsFontAwesome5.ICON_CHECK_SQUARE,
                    "##MerchAllButton",
                    "Select All",
                    width=20,
                    height=20,
                    color=ColorPalette.GetColor("GW_Disabled"),
                ):
            ...
            self.merchant_buy_quantity = PyImGui.input_int(
                "##MerchantBuyQuantity", self.merchant_buy_quantity, 1, 10, PyImGui.InputTextFlags.NoFlag
            )
