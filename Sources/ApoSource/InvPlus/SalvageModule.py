...
from Core import ImGui, get_texture_for_model
        ...
        if PyImGui.begin("SalvageButtonsWindow", window_flags):
            ...
            if ImGui.ImageButton("##text_unique_name", texture_file, 45, 45):
                GLOBAL_CACHE.Coroutines.append(
                    SalvageCheckedItems(self.salvage_checkboxes, self.keep_salvage_kits, self.deposit_materials)
                )
